...
impl Widget<'_> for Example15 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example15Props) {
			...
			props.child("1", Dynamic).run("div", |mut props| {
				...
				props.child("1", Dynamic).run("div", |mut props| {
					...
					props.child("3", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Noop("relative"), Style::MarginTop(Size::Exact(8)), Style::Noop("rounded-md"), Style::Noop("shadow-sm")]);
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("pointer-events-none"), Style::Noop("absolute"), Style::Noop("inset-y-0"), Style::Noop("left-0"), Style::Flex, Style::ItemsCenter, Style::PaddingLeft(Size::Exact(12))]);
							
							props.child("1", Dynamic).run("span", |mut props| {
								props.styles(vec![Style::TextColor(Color::Fg(56)), Style::OnScreen(Screen::Small, &[Style::Noop("text-sm")])]);
						...
						props.child("5", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("absolute"), Style::Noop("inset-y-0"), Style::Noop("right-0"), Style::Flex, Style::ItemsCenter]);
