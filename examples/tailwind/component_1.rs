...
impl Widget<'_> for Example1 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example1Props) {
		ctx.styles(vec![Style::Noop("")]);
		ctx.set_attribute("style", "");
		
		ctx.child("1", Dynamic).run("div", |mut props| {
			props.styles(vec![Style::Noop("bg-white"), Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(48)), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
			...
			props.child("1", Dynamic).run("div", |mut props| {
				...
				props.child("1", Dynamic).run("ul", |mut props| {
					...
					props.child("1", Dynamic).run("li", |mut props| {
						props.styles(vec![Style::Flex, Style::JustifyBetween, Style::Noop("gap-x-6"), Style::PaddingY(Size::Exact(20))]);
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Flex, Style::Noop("min-w-0"), Style::Noop("gap-x-4")]);
							
							props.child("1", Dynamic).run("img", |mut props| {
								props.styles(vec![Style::Width(Size::Exact(48)), Style::Width(Size::Exact(48)), Style::Noop("flex-none"), Style::Noop("rounded-full"), Style::Color(Color::Fg(6))]);
							...
							props.child("3", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Noop("min-w-0"), Style::Noop("flex-auto")]);
								...
								props.child("3", Dynamic).run("p", |mut props| {
									props.styles(vec![Style::MarginTop(Size::Exact(4)), Style::Noop("truncate"), Style::Noop("text-xs"), Style::Noop("leading-5"), Style::TextColor(Color::Fg(56))]);
						...
						props.child("3", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("hidden"), Style::Noop("shrink-0"), Style::OnScreen(Screen::Small, &[Style::Flex]), Style::OnScreen(Screen::Small, &[Style::Noop("flex-col")]), Style::OnScreen(Screen::Small, &[Style::Noop("items-end")])]);
							...
							props.child("3", Dynamic).run("p", |mut props| {
								props.styles(vec![Style::MarginTop(Size::Exact(4)), Style::Noop("text-xs"), Style::Noop("leading-5"), Style::TextColor(Color::Fg(56))]);
								
								props.child("0", Label).run(|props| props.text("Last seen"));
								props.child("1", Dynamic).run("time", |_| {});
							});
						});
					});
					...
					props.child("5", Dynamic).run("li", |mut props| {
						...
						props.child("3", Dynamic).run("div", |mut props| {
							...
							props.child("3", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::MarginTop(Size::Exact(4)), Style::Flex, Style::ItemsCenter, Style::Noop("gap-x-1.5")]);
								
								props.child("1", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Noop("flex-none"), Style::Noop("rounded-full"), Style::Noop("bg-emerald-500/20"), Style::Padding(Size::Exact(4))]);
									
									props.child("1", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Width(Size::Exact(6)), Style::Width(Size::Exact(6)), Style::Noop("rounded-full"), Style::Noop("bg-emerald-500")]);
									});
								});
								props.child("3", Dynamic).run("p", |mut props| {
									props.styles(vec![Style::Noop("text-xs"), Style::Noop("leading-5"), Style::TextColor(Color::Fg(56))]);
