...
impl Widget<'_> for Example0 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example0Props) {
		ctx.styles(vec![Style::Noop("")]);
		ctx.set_attribute("style", "");
		
		ctx.child("1", Dynamic).run("div", |mut props| {
			props.styles(vec![Style::Flex, Style::Noop("min-h-[840px]"), Style::Noop("flex-col"), Style::Noop("bg-white")]);
			...
			props.child("3", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::Flex, Style::Noop("min-h-full"), Style::Noop("flex-1"), Style::Noop("flex-col"), Style::JustifyCenter, Style::PaddingX(Size::Exact(24)), Style::PaddingY(Size::Exact(48)), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
				
				props.child("1", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::OnScreen(Screen::Small, &[Style::Noop("mx-auto")]), Style::OnScreen(Screen::Small, &[Style::Width(Size::Full)]), Style::OnScreen(Screen::Small, &[Style::Noop("max-w-sm")])]);
					
					props.child("1", Dynamic).run("img", |mut props| {
						props.styles(vec![Style::Noop("mx-auto"), Style::Width(Size::Exact(40)), Style::Noop("w-auto")]);
					...
					props.child("3", Dynamic).run("h2", |mut props| {
						props.styles(vec![Style::MarginTop(Size::Exact(40)), Style::Noop("text-center"), Style::Noop("text-2xl"), Style::FontBold, Style::Noop("leading-9"), Style::Noop("tracking-tight"), Style::TextColor(Color::Fg(100))]);
						
						props.child("0", Label).run(|props| props.text("Sign in to your account"));
					});
				});
				props.child("3", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::MarginTop(Size::Exact(40)), Style::OnScreen(Screen::Small, &[Style::Noop("mx-auto")]), Style::OnScreen(Screen::Small, &[Style::Width(Size::Full)]), Style::OnScreen(Screen::Small, &[Style::Noop("max-w-sm")])]);
							...
							props.child("1", Dynamic).run("div", |mut props| {
								...
								props.child("3", Dynamic).run("div", |mut props| {
									...
									props.child("1", Dynamic).run("a", |mut props| {
										...
										props.styles(vec![Style::FontSemibold, Style::Noop("text-indigo-600"), Style::OnHover(&[Style::Noop("text-indigo-500")])]);
					...
					props.child("3", Dynamic).run("p", |mut props| {
						props.styles(vec![Style::MarginTop(Size::Exact(40)), Style::Noop("text-center"), Style::Noop("text-sm"), Style::TextColor(Color::Fg(56))]);
						
						props.child("0", Label).run(|props| props.text("Not a member?"));
						//  space 
						props.child("3", Dynamic).run("a", |mut props| {
							props.set_attribute("href", "#");
							props.styles(vec![Style::FontSemibold, Style::Noop("leading-6"), Style::Noop("text-indigo-600"), Style::OnHover(&[Style::Noop("text-indigo-500")])]);
