...
impl Widget<'_> for Example12 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example12Props) {
		ctx.styles(vec![Style::Noop("")]);
		ctx.set_attribute("style", "");
		
		ctx.child("1", Dynamic).run("div", |mut props| {
			props.styles(vec![Style::Flex, Style::JustifyCenter, Style::Color(Color::Fg(11)), Style::Padding(Size::Exact(32))]);
			props.set_attribute("style", "min-height: 600px");
			
			props.child("1", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::Noop("mx-auto"), Style::Width(Size::Full), Style::Noop("max-w-xs")]);
					...
					props.child("3", Dynamic).run("div", |mut props| {
						...
						props.child("1", Dynamic).run("button", |mut props| {
							...
							props.child("1", Dynamic).run("span", |mut props| {
								...
								props.child("1", Dynamic).run("img", |mut props| {
									...
									props.styles(vec![Style::Width(Size::Exact(20)), Style::Width(Size::Exact(20)), Style::Noop("flex-shrink-0"), Style::Noop("rounded-full")]);
								});
								props.child("3", Dynamic).run("span", |mut props| {
									props.set_attribute("x-text", "selected.name");
									props.styles(vec![Style::MarginLeft(Size::Exact(12)), Style::Block, Style::Noop("truncate")]);
									
									props.child("0", Label).run(|props| props.text("Tom Cook"));
								});
							});
							props.child("3", Dynamic).run("span", |mut props| {
								props.styles(vec![Style::Noop("pointer-events-none"), Style::Noop("absolute"), Style::Noop("inset-y-0"), Style::Noop("right-0"), Style::MarginLeft(Size::Exact(12)), Style::Flex, Style::ItemsCenter, Style::PaddingRight(Size::Exact(8))]);
								
								props.child("1", Icon).run(|props| {
									props.style(vec![Style::Width(Size::Exact(20)), Style::Width(Size::Exact(20)), Style::TextColor(Color::Fg(44))]);
								});
							});
						});
						props.child("3", Dynamic).run("ul", |mut props| {
							...
							props.child("1", Dynamic).run("li", |mut props| {
								...
								props.styles(vec![Style::TextColor(Color::Fg(100)), Style::Noop("relative"), Style::Noop("cursor-default"), Style::Noop("select-none"), Style::PaddingY(Size::Exact(8)), Style::PaddingLeft(Size::Exact(12)), Style::PaddingRight(Size::Exact(36))]);
								...
								props.child("1", Dynamic).run("div", |mut props| {
									...
									props.child("3", Dynamic).run("span", |mut props| {
										...
										props.styles(vec![Style::Noop("font-normal"), Style::MarginLeft(Size::Exact(12)), Style::Block, Style::Noop("truncate")]);
								...
								props.child("3", Dynamic).run("span", |mut props| {
									...
									props.set_attribute("x-state:on", "Highlighted");
									props.set_attribute("x-state:off", "Not Highlighted");
									props.styles(vec![Style::Noop("text-indigo-600"), Style::Noop("absolute"), Style::Noop("inset-y-0"), Style::Noop("right-0"), Style::Flex, Style::ItemsCenter, Style::PaddingRight(Size::Exact(16))]);
