...
impl Widget<'_> for Example11 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example11Props) {
		ctx.styles(vec![Style::Noop("")]);
		ctx.set_attribute("style", "");
		
		ctx.child("1", Dynamic).run("div", |mut props| {
			props.styles(vec![Style::Noop("bg-white"), Style::Padding(Size::Exact(32))]);
			props.set_attribute("style", "min-height: 384px");
			
			props.child("1", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::Noop("mx-auto"), Style::Noop("max-w-7xl")]);
				
				props.child("1", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::OnScreen(Screen::Large, &[Style::Flex]), Style::OnScreen(Screen::Large, &[Style::ItemsCenter]), Style::OnScreen(Screen::Large, &[Style::JustifyBetween])]);
					
					props.child("1", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Noop("min-w-0"), Style::Noop("flex-1")]);
						
						props.child("1", Dynamic).run("h2", |mut props| {
							props.styles(vec![Style::Noop("text-2xl"), Style::FontBold, Style::Noop("leading-7"), Style::TextColor(Color::Fg(100)), Style::OnScreen(Screen::Small, &[Style::Noop("truncate")]), Style::OnScreen(Screen::Small, &[Style::Noop("text-3xl")]), Style::OnScreen(Screen::Small, &[Style::Noop("tracking-tight")])]);
							
							props.child("0", Label).run(|props| props.text("Back End Developer"));
						});
						props.child("3", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::MarginTop(Size::Exact(4)), Style::Flex, Style::Noop("flex-col"), Style::OnScreen(Screen::Small, &[Style::MarginTop(Size::Exact(0))]), Style::OnScreen(Screen::Small, &[Style::Noop("flex-row")]), Style::OnScreen(Screen::Small, &[Style::Noop("flex-wrap")]), Style::OnScreen(Screen::Small, &[Style::SpaceX(Size::Exact(24))])]);
							
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::MarginTop(Size::Exact(8)), Style::Flex, Style::ItemsCenter, Style::Noop("text-sm"), Style::TextColor(Color::Fg(56))]);
					...
					props.child("3", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::MarginTop(Size::Exact(20)), Style::Flex, Style::OnScreen(Screen::Large, &[Style::MarginLeft(Size::Exact(16))]), Style::OnScreen(Screen::Large, &[Style::MarginTop(Size::Exact(0))])]);
						
						props.child("1", Dynamic).run("span", |mut props| {
							props.styles(vec![Style::Noop("hidden"), Style::OnScreen(Screen::Small, &[Style::Block])]);
							
							props.child("1", Dynamic).run("button", |mut props| {
								props.set_attribute("type", "button");
								props.styles(vec![Style::InlineFlex, Style::ItemsCenter, Style::Noop("rounded-md"), Style::Noop("bg-white"), Style::PaddingX(Size::Exact(12)), Style::PaddingY(Size::Exact(8)), Style::Noop("text-sm"), Style::FontSemibold, Style::TextColor(Color::Fg(100)), Style::Noop("shadow-sm"), Style::Noop("ring-1"), Style::Noop("ring-inset"), Style::Noop("ring-gray-300"), Style::OnHover(&[Style::Color(Color::Fg(6))])]);
								
								props.child("1", Icon).run(|props| {
									props.style(vec![Style::Noop("-ml-0.5"), Style::MarginRight(Size::Exact(6)), Style::Width(Size::Exact(20)), Style::Width(Size::Exact(20)), Style::TextColor(Color::Fg(44))]);
								});
								props.child("2", Label).run(|props| props.text("Edit"));
							});
						});
						props.child("3", Dynamic).run("span", |mut props| {
							props.styles(vec![Style::MarginLeft(Size::Exact(12)), Style::Noop("hidden"), Style::OnScreen(Screen::Small, &[Style::Block])]);
						...
						props.child("5", Dynamic).run("span", |mut props| {
							props.styles(vec![Style::OnScreen(Screen::Small, &[Style::MarginLeft(Size::Exact(12))])]);
							
							props.child("1", Dynamic).run("button", |mut props| {
								props.set_attribute("type", "button");
								props.styles(vec![Style::InlineFlex, Style::ItemsCenter, Style::Noop("rounded-md"), Style::Noop("bg-indigo-600"), Style::PaddingX(Size::Exact(12)), Style::PaddingY(Size::Exact(8)), Style::Noop("text-sm"), Style::FontSemibold, Style::Noop("text-white"), Style::Noop("shadow-sm"), Style::OnHover(&[Style::Noop("bg-indigo-500")]), Style::NoopGroup("focus-visible", &[Style::Noop("outline")]), Style::NoopGroup("focus-visible", &[Style::Noop("outline-2")]), Style::NoopGroup("focus-visible", &[Style::Noop("outline-offset-2")]), Style::NoopGroup("focus-visible", &[Style::Noop("outline-indigo-600")])]);
								
								props.child("1", Icon).run(|props| {
									props.style(vec![Style::Noop("-ml-0.5"), Style::MarginRight(Size::Exact(6)), Style::Width(Size::Exact(20)), Style::Width(Size::Exact(20))]);
								});
						...
						props.child("9", Dynamic).run("div", |mut props| {
							...
							props.styles(vec![Style::Noop("relative"), Style::MarginLeft(Size::Exact(12)), Style::OnScreen(Screen::Small, &[Style::Noop("hidden")])]);
							...
							props.child("1", Dynamic).run("button", |mut props| {
								...
								props.child("1", Icon).run(|props| {
									props.style(vec![Style::Noop("-mr-1"), Style::MarginLeft(Size::Exact(6)), Style::Width(Size::Exact(20)), Style::Width(Size::Exact(20)), Style::TextColor(Color::Fg(44))]);
								});
							});
							props.child("3", Dynamic).run("div", |mut props| {
