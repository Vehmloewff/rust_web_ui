...
impl Widget<'_> for Example30 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example30Props) {
		...
		ctx.child("1", Dynamic).run("div", |mut props| {
			...
			props.child("1", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::Flex, Style::ItemsCenter, Style::JustifyCenter, Style::Padding(Size::Exact(32))]);
				...
				props.child("1", Dynamic).run("div", |mut props| {
					...
					props.child("1", Dynamic).run("button", |mut props| {
						...
						props.styles(vec![Style::InlineFlex, Style::ItemsCenter, Style::Noop("gap-x-1"), Style::Noop("text-sm"), Style::FontSemibold, Style::Noop("leading-6"), Style::TextColor(Color::Fg(100))]);
					...
					props.child("3", Dynamic).run("div", |mut props| {
						...
						props.styles(vec![Style::Noop("absolute"), Style::Noop("left-1/2"), Style::Noop("z-10"), Style::MarginTop(Size::Exact(20)), Style::Flex, Style::Noop("w-screen"), Style::Noop("max-w-max"), Style::Noop("-translate-x-1/2"), Style::PaddingX(Size::Exact(16))]);
						props.set_attribute("x-ref", "panel");
						props.set_attribute("@click.away", "open = false");
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("w-screen"), Style::Noop("max-w-md"), Style::Noop("flex-auto"), Style::Noop("overflow-hidden"), Style::Noop("rounded-3xl"), Style::Noop("bg-white"), Style::Noop("text-sm"), Style::Noop("leading-6"), Style::Noop("shadow-lg"), Style::Noop("ring-1"), Style::Noop("ring-gray-900/5")]);
							
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Padding(Size::Exact(16))]);
								
								props.child("1", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Noop("group"), Style::Noop("relative"), Style::Flex, Style::Noop("gap-x-6"), Style::Noop("rounded-lg"), Style::Padding(Size::Exact(16)), Style::OnHover(&[Style::Color(Color::Fg(6))])]);
									
									props.child("1", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::MarginTop(Size::Exact(4)), Style::Flex, Style::Width(Size::Exact(44)), Style::Width(Size::Exact(44)), Style::Noop("flex-none"), Style::ItemsCenter, Style::JustifyCenter, Style::Noop("rounded-lg"), Style::Color(Color::Fg(6)), Style::NoopGroup("group-hover", &[Style::Noop("bg-white")])]);
							...
							props.child("3", Dynamic).run("div", |mut props| {
								...
								props.child("1", Dynamic).run("a", |mut props| {
									props.set_attribute("href", "#");
									props.styles(vec![Style::Flex, Style::ItemsCenter, Style::JustifyCenter, Style::Noop("gap-x-2.5"), Style::Padding(Size::Exact(12)), Style::FontSemibold, Style::TextColor(Color::Fg(100)), Style::OnHover(&[Style::Color(Color::Fg(11))])]);
