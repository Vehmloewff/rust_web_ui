...
impl Widget<'_> for Example20 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example20Props) {
		ctx.styles(vec![Style::Noop("")]);
		ctx.set_attribute("style", "");
		
		ctx.child("1", Dynamic).run("div", |mut props| {
			props.styles(vec![Style::Noop("min-h-[583px]"), Style::Noop("overflow-auto"), Style::Noop("bg-white")]);
			...
			props.child("1", Dynamic).run("div", |mut props| {
				...
				props.child("3", Dynamic).run("div", |mut props| {
					...
					props.styles(vec![Style::Noop("relative"), Style::Noop("z-40"), Style::OnScreen(Screen::Large, &[Style::Noop("hidden")])]);
					...
					props.child("1", Dynamic).run("div", |mut props| {
						...
						props.styles(vec![Style::Noop("fixed"), Style::Noop("inset-0"), Style::Noop("bg-black"), Style::Noop("bg-opacity-25")]);
					});
					props.child("3", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Noop("fixed"), Style::Noop("inset-0"), Style::Noop("z-40"), Style::Flex]);
						...
						props.child("1", Dynamic).run("div", |mut props| {
							...
							props.styles(vec![Style::Noop("relative"), Style::Flex, Style::Width(Size::Full), Style::Noop("max-w-xs"), Style::Noop("flex-col"), Style::Noop("overflow-y-auto"), Style::Noop("bg-white"), Style::PaddingBottom(Size::Exact(48)), Style::Noop("shadow-xl")]);
							props.set_attribute("@click.away", "open = false");
							
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Flex, Style::PaddingX(Size::Exact(16)), Style::PaddingBottom(Size::Exact(8)), Style::PaddingTop(Size::Exact(20))]);
								
								props.child("1", Dynamic).run("button", |mut props| {
									props.set_attribute("type", "button");
									props.styles(vec![Style::Noop("relative"), Style::Noop("-m-2"), Style::InlineFlex, Style::ItemsCenter, Style::JustifyCenter, Style::Noop("rounded-md"), Style::Padding(Size::Exact(8)), Style::TextColor(Color::Fg(44))]);
									props.set_attribute("@click", "open = false");
									
									props.child("1", Dynamic).run("span", |mut props| {
										props.styles(vec![Style::Noop("absolute"), Style::Noop("-inset-0.5")]);
									});
									...
									props.child("5", Icon).run(|props| {
										props.style(vec![Style::Width(Size::Exact(24)), Style::Width(Size::Exact(24))]);
									});
								});
							});
							//  Links 
							props.child("5", Dynamic).run("div", |mut props| {
								...
								props.child("1", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Noop("border-b"), Style::Noop("border-gray-200")]);
									
									props.child("1", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Noop("-mb-px"), Style::Flex, Style::SpaceX(Size::Exact(32)), Style::PaddingX(Size::Exact(16))]);
										props.set_attribute("aria-orientation", "horizontal");
										props.set_attribute("role", "tablist");
										
										props.child("1", Dynamic).run("button", |mut props| {
											props.set_attribute("id", "tabs-1-tab-1");
											props.styles(vec![Style::Noop("border-transparent"), Style::TextColor(Color::Fg(100)), Style::Noop("flex-1"), Style::Noop("whitespace-nowrap"), Style::Noop("border-b-2"), Style::PaddingX(Size::Exact(4)), Style::PaddingY(Size::Exact(16)), Style::Noop("text-base"), Style::Noop("font-medium")]);
								...
								props.child("3", Dynamic).run("div", |mut props| {
									...
									props.styles(vec![Style::SpaceY(Size::Exact(40)), Style::PaddingX(Size::Exact(16)), Style::PaddingBottom(Size::Exact(32)), Style::PaddingTop(Size::Exact(40))]);
									...
									props.child("1", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Noop("grid"), Style::Noop("grid-cols-2"), Style::Noop("gap-x-4")]);
										
										props.child("1", Dynamic).run("div", |mut props| {
											props.styles(vec![Style::Noop("group"), Style::Noop("relative"), Style::Noop("text-sm")]);
											
											props.child("1", Dynamic).run("div", |mut props| {
												props.styles(vec![Style::Noop("aspect-h-1"), Style::Noop("aspect-w-1"), Style::Noop("overflow-hidden"), Style::Noop("rounded-lg"), Style::Color(Color::Fg(11)), Style::NoopGroup("group-hover", &[Style::Noop("opacity-75")])]);
												...
												props.child("1", Dynamic).run("img", |mut props| {
													...
													props.styles(vec![Style::Noop("object-cover"), Style::Noop("object-center")]);
												});
											});
											props.child("3", Dynamic).run("a", |mut props| {
												props.set_attribute("href", "#");
												props.styles(vec![Style::MarginTop(Size::Exact(24)), Style::Block, Style::Noop("font-medium"), Style::TextColor(Color::Fg(100))]);
												
												props.child("1", Dynamic).run("span", |mut props| {
													props.styles(vec![Style::Noop("absolute"), Style::Noop("inset-0"), Style::Noop("z-10")]);
											...
											props.child("5", Dynamic).run("p", |mut props| {
												props.set_attribute("aria-hidden", "true");
												props.styles(vec![Style::MarginTop(Size::Exact(4))]);
									...
									props.child("3", Dynamic).run("div", |mut props| {
										...
										props.child("3", Dynamic).run("ul", |mut props| {
											...
											props.styles(vec![Style::MarginTop(Size::Exact(24)), Style::Flex, Style::Noop("flex-col"), Style::SpaceY(Size::Exact(24))]);
											
											props.child("1", Dynamic).run("li", |mut props| {
												props.styles(vec![Style::Noop("flow-root")]);
												
												props.child("1", Dynamic).run("a", |mut props| {
													props.set_attribute("href", "#");
													props.styles(vec![Style::Noop("-m-2"), Style::Block, Style::Padding(Size::Exact(8)), Style::TextColor(Color::Fg(56))]);
							...
							props.child("7", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::SpaceY(Size::Exact(24)), Style::Noop("border-t"), Style::Noop("border-gray-200"), Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(24))]);
								...
								props.child("1", Dynamic).run("div", |mut props| {
									...
									props.child("1", Dynamic).run("a", |mut props| {
										props.set_attribute("href", "#");
										props.styles(vec![Style::Noop("-m-2"), Style::Block, Style::Padding(Size::Exact(8)), Style::Noop("font-medium"), Style::TextColor(Color::Fg(100))]);
							...
							props.child("11", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Noop("border-t"), Style::Noop("border-gray-200"), Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(24))]);
								
								props.child("1", Dynamic).run("a", |mut props| {
									props.set_attribute("href", "#");
									props.styles(vec![Style::Noop("-m-2"), Style::Flex, Style::ItemsCenter, Style::Padding(Size::Exact(8))]);
									
									props.child("1", Dynamic).run("img", |mut props| {
										props.set_attribute("src", "https://tailwindui.com/img/flags/flag-canada.svg");
										props.set_attribute("alt", "");
										props.styles(vec![Style::Block, Style::Noop("h-auto"), Style::Width(Size::Exact(20)), Style::Noop("flex-shrink-0")]);
									});
									props.child("3", Dynamic).run("span", |mut props| {
										props.styles(vec![Style::MarginLeft(Size::Exact(12)), Style::Block, Style::Noop("text-base"), Style::Noop("font-medium"), Style::TextColor(Color::Fg(100))]);
				...
				props.child("5", Dynamic).run("header", |mut props| {
					props.styles(vec![Style::Noop("relative"), Style::Noop("bg-white")]);
					
					props.child("1", Dynamic).run("p", |mut props| {
						props.styles(vec![Style::Flex, Style::Width(Size::Exact(40)), Style::ItemsCenter, Style::JustifyCenter, Style::Noop("bg-indigo-600"), Style::PaddingX(Size::Exact(16)), Style::Noop("text-sm"), Style::Noop("font-medium"), Style::Noop("text-white"), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
					...
					props.child("3", Dynamic).run("nav", |mut props| {
						...
						props.styles(vec![Style::Noop("mx-auto"), Style::Noop("max-w-7xl"), Style::PaddingX(Size::Exact(16)), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("border-b"), Style::Noop("border-gray-200")]);
							
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Flex, Style::Width(Size::Exact(64)), Style::ItemsCenter]);
								
								props.child("1", Dynamic).run("button", |mut props| {
									props.set_attribute("type", "button");
									props.set_attribute("x-description", "Mobile menu toggle, controls the 'mobileMenuOpen' state.");
									props.styles(vec![Style::Noop("relative"), Style::Noop("rounded-md"), Style::Noop("bg-white"), Style::Padding(Size::Exact(8)), Style::TextColor(Color::Fg(44)), Style::OnScreen(Screen::Large, &[Style::Noop("hidden")])]);
								...
								//  Logo 
								props.child("5", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::MarginLeft(Size::Exact(16)), Style::Flex, Style::OnScreen(Screen::Large, &[Style::MarginLeft(Size::Exact(0))])]);
									...
									props.child("1", Dynamic).run("a", |mut props| {
										...
										props.child("3", Dynamic).run("img", |mut props| {
											props.styles(vec![Style::Width(Size::Exact(32)), Style::Noop("w-auto")]);
								...
								//  Flyout menus 
								props.child("9", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Noop("hidden"), Style::OnScreen(Screen::Large, &[Style::MarginLeft(Size::Exact(32))]), Style::OnScreen(Screen::Large, &[Style::Block]), Style::OnScreen(Screen::Large, &[Style::Noop("self-stretch")])]);
									props.set_attribute("x-data", "Components.popoverGroup()");
									props.set_attribute("x-init", "init()");
									
									props.child("1", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Flex, Style::Width(Size::Full), Style::SpaceX(Size::Exact(32))]);
										
										props.child("1", Dynamic).run("div", |mut props| {
											props.styles(vec![Style::Flex]);
											...
											props.child("1", Dynamic).run("div", |mut props| {
												props.styles(vec![Style::Noop("relative"), Style::Flex]);
												
												props.child("1", Dynamic).run("button", |mut props| {
													props.set_attribute("type", "button");
													props.set_attribute("x-state:on", "Item active");
													props.set_attribute("x-state:off", "Item inactive");
													props.styles(vec![Style::Noop("border-transparent"), Style::TextColor(Color::Fg(78)), Style::OnHover(&[Style::TextColor(Color::Fg(89))]), Style::Noop("relative"), Style::Noop("z-10"), Style::Noop("-mb-px"), Style::Flex, Style::ItemsCenter, Style::Noop("border-b-2"), Style::Noop("pt-px"), Style::Noop("text-sm"), Style::Noop("font-medium"), Style::Noop("transition-colors"), Style::Noop("duration-200"), Style::Noop("ease-out")]);
											...
											props.child("3", Dynamic).run("div", |mut props| {
												...
												props.styles(vec![Style::Noop("absolute"), Style::Noop("inset-x-0"), Style::Noop("top-full"), Style::Noop("text-sm"), Style::TextColor(Color::Fg(56))]);
												props.set_attribute("x-ref", "panel");
												props.set_attribute("@click.away", "open = false");
												
												//  Presentational element used to render the bottom shadow, if we put the shadow on the actual panel it pokes out the top, so we use this shorter element to hide the top of the shadow 
												props.child("3", Dynamic).run("div", |mut props| {
													props.styles(vec![Style::Noop("absolute"), Style::Noop("inset-0"), Style::Noop("top-1/2"), Style::Noop("bg-white"), Style::Noop("shadow")]);
													props.set_attribute("aria-hidden", "true");
												});
												props.child("5", Dynamic).run("div", |mut props| {
													props.styles(vec![Style::Noop("relative"), Style::Noop("bg-white")]);
													...
													props.child("1", Dynamic).run("div", |mut props| {
														props.styles(vec![Style::Noop("mx-auto"), Style::Noop("max-w-7xl"), Style::PaddingX(Size::Exact(32))]);
														
														props.child("1", Dynamic).run("div", |mut props| {
															props.styles(vec![Style::Noop("grid"), Style::Noop("grid-cols-2"), Style::Noop("gap-x-8"), Style::Noop("gap-y-10"), Style::PaddingY(Size::Exact(64))]);
															
															props.child("1", Dynamic).run("div", |mut props| {
																props.styles(vec![Style::Noop("col-start-2"), Style::Noop("grid"), Style::Noop("grid-cols-2"), Style::Noop("gap-x-8")]);
																
																props.child("1", Dynamic).run("div", |mut props| {
																	props.styles(vec![Style::Noop("group"), Style::Noop("relative"), Style::Noop("text-base"), Style::OnScreen(Screen::Small, &[Style::Noop("text-sm")])]);
															...
															props.child("3", Dynamic).run("div", |mut props| {
																props.styles(vec![Style::Noop("row-start-1"), Style::Noop("grid"), Style::Noop("grid-cols-3"), Style::Noop("gap-x-8"), Style::Noop("gap-y-10"), Style::Noop("text-sm")]);
																...
																props.child("1", Dynamic).run("div", |mut props| {
																	...
																	props.child("3", Dynamic).run("ul", |mut props| {
																		...
																		props.styles(vec![Style::MarginTop(Size::Exact(24)), Style::SpaceY(Size::Exact(24)), Style::OnScreen(Screen::Small, &[Style::MarginTop(Size::Exact(16))]), Style::OnScreen(Screen::Small, &[Style::SpaceY(Size::Exact(16))])]);
																		...
																		props.child("1", Dynamic).run("li", |mut props| {
																			...
																			props.child("1", Dynamic).run("a", |mut props| {
																				props.set_attribute("href", "#");
																				props.styles(vec![Style::OnHover(&[Style::TextColor(Color::Fg(89))])]);
										...
										props.child("5", Dynamic).run("a", |mut props| {
											props.set_attribute("href", "#");
											props.styles(vec![Style::Flex, Style::ItemsCenter, Style::Noop("text-sm"), Style::Noop("font-medium"), Style::TextColor(Color::Fg(78)), Style::OnHover(&[Style::TextColor(Color::Fg(89))])]);
								...
								props.child("11", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Noop("ml-auto"), Style::Flex, Style::ItemsCenter]);
									
									props.child("1", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Noop("hidden"), Style::OnScreen(Screen::Large, &[Style::Flex]), Style::OnScreen(Screen::Large, &[Style::Noop("flex-1")]), Style::OnScreen(Screen::Large, &[Style::ItemsCenter]), Style::OnScreen(Screen::Large, &[Style::Noop("justify-end")]), Style::OnScreen(Screen::Large, &[Style::SpaceX(Size::Exact(24))])]);
										
										props.child("1", Dynamic).run("a", |mut props| {
											props.set_attribute("href", "#");
											props.styles(vec![Style::Noop("text-sm"), Style::Noop("font-medium"), Style::TextColor(Color::Fg(78)), Style::OnHover(&[Style::TextColor(Color::Fg(89))])]);
											
											props.child("0", Label).run(|props| props.text("Sign in"));
										});
										props.child("3", Dynamic).run("span", |mut props| {
											props.styles(vec![Style::Width(Size::Exact(24)), Style::Noop("w-px"), Style::Color(Color::Fg(22))]);
											props.set_attribute("aria-hidden", "true");
										});
										props.child("5", Dynamic).run("a", |mut props| {
											props.set_attribute("href", "#");
									...
									props.child("3", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Noop("hidden"), Style::OnScreen(Screen::Large, &[Style::MarginLeft(Size::Exact(32))]), Style::OnScreen(Screen::Large, &[Style::Flex])]);
										
										props.child("1", Dynamic).run("a", |mut props| {
											props.set_attribute("href", "#");
											props.styles(vec![Style::Flex, Style::ItemsCenter, Style::TextColor(Color::Fg(78)), Style::OnHover(&[Style::TextColor(Color::Fg(89))])]);
											...
											props.child("3", Dynamic).run("span", |mut props| {
												props.styles(vec![Style::MarginLeft(Size::Exact(12)), Style::Block, Style::Noop("text-sm"), Style::Noop("font-medium")]);
									...
									//  Search 
									props.child("7", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Flex, Style::OnScreen(Screen::Large, &[Style::MarginLeft(Size::Exact(24))])]);
										
										props.child("1", Dynamic).run("a", |mut props| {
											props.set_attribute("href", "#");
											props.styles(vec![Style::Padding(Size::Exact(8)), Style::TextColor(Color::Fg(44)), Style::OnHover(&[Style::TextColor(Color::Fg(56))])]);
									...
									//  Cart 
									props.child("11", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::MarginLeft(Size::Exact(16)), Style::Noop("flow-root"), Style::OnScreen(Screen::Large, &[Style::MarginLeft(Size::Exact(24))])]);
										
										props.child("1", Dynamic).run("a", |mut props| {
											props.set_attribute("href", "#");
											props.styles(vec![Style::Noop("group"), Style::Noop("-m-2"), Style::Flex, Style::ItemsCenter, Style::Padding(Size::Exact(8))]);
											
											props.child("1", Icon).run(|props| {
												props.style(vec![Style::Width(Size::Exact(24)), Style::Width(Size::Exact(24)), Style::Noop("flex-shrink-0"), Style::TextColor(Color::Fg(44)), Style::NoopGroup("group-hover", &[Style::TextColor(Color::Fg(56))])]);
											});
											props.child("3", Dynamic).run("span", |mut props| {
												props.styles(vec![Style::MarginLeft(Size::Exact(8)), Style::Noop("text-sm"), Style::Noop("font-medium"), Style::TextColor(Color::Fg(78)), Style::NoopGroup("group-hover", &[Style::TextColor(Color::Fg(89))])]);
