...
impl Widget<'_> for Example24 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example24Props) {
		...
		ctx.child("1", Dynamic).run("div", |mut props| {
			...
			props.child("1", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::PaddingTop(Size::Exact(24))]);
				...
				props.child("1", Dynamic).run("nav", |mut props| {
					...
					props.child("1", Dynamic).run("ol", |mut props| {
						...
						props.styles(vec![Style::Noop("mx-auto"), Style::Flex, Style::Noop("max-w-2xl"), Style::ItemsCenter, Style::SpaceX(Size::Exact(8)), Style::PaddingX(Size::Exact(16)), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))]), Style::OnScreen(Screen::Large, &[Style::Noop("max-w-7xl")]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
						
						props.child("1", Dynamic).run("li", |mut props| {
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Flex, Style::ItemsCenter]);
								
								props.child("1", Dynamic).run("a", |mut props| {
									props.set_attribute("href", "#");
									props.styles(vec![Style::MarginRight(Size::Exact(8)), Style::Noop("text-sm"), Style::Noop("font-medium"), Style::TextColor(Color::Fg(100))]);
									
									props.child("0", Label).run(|props| props.text("Men"));
								});
								props.child("3", Icon).run(|props| {
									props.style(vec![Style::Width(Size::Exact(20)), Style::Width(Size::Exact(16)), Style::TextColor(Color::Fg(33))]);
								});
							});
						});
						...
						props.child("5", Dynamic).run("li", |mut props| {
							props.styles(vec![Style::Noop("text-sm")]);
							
							props.child("1", Dynamic).run("a", |mut props| {
								props.set_attribute("href", "#");
								props.set_attribute("aria-current", "page");
								props.styles(vec![Style::Noop("font-medium"), Style::TextColor(Color::Fg(56)), Style::OnHover(&[Style::TextColor(Color::Fg(67))])]);
				...
				props.child("5", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::Noop("mx-auto"), Style::MarginTop(Size::Exact(24)), Style::Noop("max-w-2xl"), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))]), Style::OnScreen(Screen::Large, &[Style::Noop("grid")]), Style::OnScreen(Screen::Large, &[Style::Noop("max-w-7xl")]), Style::OnScreen(Screen::Large, &[Style::Noop("grid-cols-3")]), Style::OnScreen(Screen::Large, &[Style::Noop("gap-x-8")]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
					
					props.child("1", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Noop("aspect-h-4"), Style::Noop("aspect-w-3"), Style::Noop("hidden"), Style::Noop("overflow-hidden"), Style::Noop("rounded-lg"), Style::OnScreen(Screen::Large, &[Style::Block])]);
						...
						props.child("1", Dynamic).run("img", |mut props| {
							...
							props.styles(vec![Style::Width(Size::Full), Style::Width(Size::Full), Style::Noop("object-cover"), Style::Noop("object-center")]);
						});
					});
					props.child("3", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Noop("hidden"), Style::OnScreen(Screen::Large, &[Style::Noop("grid")]), Style::OnScreen(Screen::Large, &[Style::Noop("grid-cols-1")]), Style::OnScreen(Screen::Large, &[Style::Noop("gap-y-8")])]);
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("aspect-h-2"), Style::Noop("aspect-w-3"), Style::Noop("overflow-hidden"), Style::Noop("rounded-lg")]);
					...
					props.child("5", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Noop("aspect-h-5"), Style::Noop("aspect-w-4"), Style::OnScreen(Screen::Large, &[Style::Noop("aspect-h-4")]), Style::OnScreen(Screen::Large, &[Style::Noop("aspect-w-3")]), Style::OnScreen(Screen::Small, &[Style::Noop("overflow-hidden")]), Style::OnScreen(Screen::Small, &[Style::Noop("rounded-lg")])]);
				...
				props.child("9", Dynamic).run("div", |mut props| {
					...
					//  Options 
					props.child("5", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::MarginTop(Size::Exact(16)), Style::OnScreen(Screen::Large, &[Style::Noop("row-span-3")]), Style::OnScreen(Screen::Large, &[Style::MarginTop(Size::Exact(0))])]);
						...
						props.child("3", Dynamic).run("p", |mut props| {
							props.styles(vec![Style::Noop("text-3xl"), Style::Noop("tracking-tight"), Style::TextColor(Color::Fg(100))]);
							
							props.child("0", Label).run(|props| props.text("$192"));
						});
						//  Reviews 
						props.child("7", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::MarginTop(Size::Exact(24))]);
							...
							props.child("3", Dynamic).run("div", |mut props| {
								...
								props.child("1", Dynamic).run("div", |mut props| {
									...
									props.child("1", Icon).run(|props| {
										props.style(vec![Style::TextColor(Color::Fg(100)), Style::Width(Size::Exact(20)), Style::Width(Size::Exact(20)), Style::Noop("flex-shrink-0")]);
									});
									props.child("3", Icon).run(|props| {
										props.style(vec![Style::TextColor(Color::Fg(100)), Style::Width(Size::Exact(20)), Style::Width(Size::Exact(20)), Style::Noop("flex-shrink-0")]);
									});
									...
									props.child("9", Icon).run(|props| {
										props.style(vec![Style::TextColor(Color::Fg(22)), Style::Width(Size::Exact(20)), Style::Width(Size::Exact(20)), Style::Noop("flex-shrink-0")]);
									});
								});
								props.child("3", Dynamic).run("p", |mut props| {
									props.styles(vec![Style::Noop("sr-only")]);
								...
								props.child("5", Dynamic).run("a", |mut props| {
									props.set_attribute("href", "#");
									props.styles(vec![Style::MarginLeft(Size::Exact(12)), Style::Noop("text-sm"), Style::Noop("font-medium"), Style::Noop("text-indigo-600"), Style::OnHover(&[Style::Noop("text-indigo-500")])]);
						...
						props.child("9", Dynamic).run("form", |mut props| {
							props.styles(vec![Style::MarginTop(Size::Exact(40))]);
							
							//  Colors 
							props.child("3", Dynamic).run("div", |mut props| {
								props.child("1", Dynamic).run("h3", |mut props| {
									props.styles(vec![Style::Noop("text-sm"), Style::Noop("font-medium"), Style::TextColor(Color::Fg(100))]);
								...
								props.child("3", Dynamic).run("fieldset", |mut props| {
									...
									props.styles(vec![Style::MarginTop(Size::Exact(16))]);
									...
									props.child("3", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Flex, Style::ItemsCenter, Style::SpaceX(Size::Exact(12))]);
										
										props.child("1", Dynamic).run("label", |mut props| {
											props.set_attribute("x-radio-group-option", "");
											props.styles(vec![Style::Noop("relative"), Style::Noop("-m-0.5"), Style::Flex, Style::Noop("cursor-pointer"), Style::ItemsCenter, Style::JustifyCenter, Style::Noop("rounded-full"), Style::Padding(Size::Exact(2)), Style::OnFocus(&[Style::Noop("outline-none")]), Style::Noop("ring-gray-400")]);
											...
											props.child("5", Dynamic).run("span", |mut props| {
												...
												props.styles(vec![Style::Width(Size::Exact(32)), Style::Width(Size::Exact(32)), Style::Noop("bg-white"), Style::Noop("rounded-full"), Style::Noop("border"), Style::Noop("border-black"), Style::Noop("border-opacity-10")]);
											});
										});
										props.child("3", Dynamic).run("label", |mut props| {
											...
											props.child("5", Dynamic).run("span", |mut props| {
												props.set_attribute("aria-hidden", "true");
												props.styles(vec![Style::Width(Size::Exact(32)), Style::Width(Size::Exact(32)), Style::Color(Color::Fg(22)), Style::Noop("rounded-full"), Style::Noop("border"), Style::Noop("border-black"), Style::Noop("border-opacity-10")]);
											});
										});
										props.child("5", Dynamic).run("label", |mut props| {
											props.set_attribute("x-radio-group-option", "");
											props.styles(vec![Style::Noop("relative"), Style::Noop("-m-0.5"), Style::Flex, Style::Noop("cursor-pointer"), Style::ItemsCenter, Style::JustifyCenter, Style::Noop("rounded-full"), Style::Padding(Size::Exact(2)), Style::OnFocus(&[Style::Noop("outline-none")]), Style::Noop("ring-gray-900")]);
											props.set_attribute("x-description", r#"Active and Checked: "ring ring-offset-1"	Not Active and Checked: "ring-2""#);
											...
											props.child("5", Dynamic).run("span", |mut props| {
												props.set_attribute("aria-hidden", "true");
												props.styles(vec![Style::Width(Size::Exact(32)), Style::Width(Size::Exact(32)), Style::Color(Color::Fg(100)), Style::Noop("rounded-full"), Style::Noop("border"), Style::Noop("border-black"), Style::Noop("border-opacity-10")]);
											});
										});
									});
								});
							...
							props.child("7", Dynamic).run("div", |mut props| {
								...
								props.child("1", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Flex, Style::ItemsCenter, Style::JustifyBetween]);
									...
									props.child("3", Dynamic).run("a", |mut props| {
										props.set_attribute("href", "#");
										props.styles(vec![Style::Noop("text-sm"), Style::Noop("font-medium"), Style::Noop("text-indigo-600"), Style::OnHover(&[Style::Noop("text-indigo-500")])]);
								...
								props.child("3", Dynamic).run("fieldset", |mut props| {
									...
									props.child("3", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Noop("grid"), Style::Noop("grid-cols-4"), Style::Noop("gap-4"), Style::OnScreen(Screen::Small, &[Style::Noop("grid-cols-8")]), Style::OnScreen(Screen::Large, &[Style::Noop("grid-cols-4")])]);
										
										props.child("1", Dynamic).run("label", |mut props| {
											props.set_attribute("x-radio-group-option", "");
											props.styles(vec![Style::Noop("group"), Style::Noop("relative"), Style::Flex, Style::ItemsCenter, Style::JustifyCenter, Style::Noop("rounded-md"), Style::Noop("border"), Style::PaddingY(Size::Exact(12)), Style::PaddingX(Size::Exact(16)), Style::Noop("text-sm"), Style::Noop("font-medium"), Style::Noop("uppercase"), Style::OnHover(&[Style::Color(Color::Fg(6))]), Style::OnFocus(&[Style::Noop("outline-none")]), Style::OnScreen(Screen::Small, &[Style::Noop("flex-1")]), Style::OnScreen(Screen::Small, &[Style::PaddingY(Size::Exact(24))]), Style::Noop("cursor-not-allowed"), Style::Color(Color::Fg(6)), Style::TextColor(Color::Fg(22))]);
											...
											props.child("3", Dynamic).run("span", |_| {});
											props.child("5", Dynamic).run("span", |mut props| {
												props.set_attribute("aria-hidden", "true");
												props.styles(vec![Style::Noop("pointer-events-none"), Style::Noop("absolute"), Style::Noop("-inset-px"), Style::Noop("rounded-md"), Style::Noop("border-2"), Style::Noop("border-gray-200")]);
												
												props.child("1", Icon).run(|props| {
													props.style(vec![Style::Noop("absolute"), Style::Noop("inset-0"), Style::Width(Size::Full), Style::Width(Size::Full), Style::Noop("stroke-2"), Style::TextColor(Color::Fg(22))]);
												});
											});
										});
										props.child("3", Dynamic).run("label", |mut props| {
											...
											props.child("3", Dynamic).run("span", |_| {});
											props.child("5", Dynamic).run("span", |mut props| {
												props.styles(vec![Style::Noop("pointer-events-none"), Style::Noop("absolute"), Style::Noop("-inset-px"), Style::Noop("rounded-md")]);
												props.set_attribute("aria-hidden", "true");
					...
					props.child("7", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::PaddingY(Size::Exact(40)), Style::OnScreen(Screen::Large, &[Style::Noop("col-span-2")]), Style::OnScreen(Screen::Large, &[Style::Noop("col-start-1")]), Style::OnScreen(Screen::Large, &[Style::Noop("border-r")]), Style::OnScreen(Screen::Large, &[Style::Noop("border-gray-200")]), Style::OnScreen(Screen::Large, &[Style::PaddingBottom(Size::Exact(64))]), Style::OnScreen(Screen::Large, &[Style::PaddingRight(Size::Exact(32))]), Style::OnScreen(Screen::Large, &[Style::PaddingTop(Size::Exact(24))])]);
						...
						props.child("3", Dynamic).run("div", |mut props| {
							...
							props.child("3", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::SpaceY(Size::Exact(24))]);
								
								props.child("1", Dynamic).run("p", |mut props| {
									props.styles(vec![Style::Noop("text-base"), Style::TextColor(Color::Fg(100))]);
						...
						props.child("5", Dynamic).run("div", |mut props| {
							...
							props.child("3", Dynamic).run("div", |mut props| {
								...
								props.child("1", Dynamic).run("ul", |mut props| {
									props.set_attribute("role", "list");
									props.styles(vec![Style::Noop("list-disc"), Style::SpaceY(Size::Exact(8)), Style::PaddingLeft(Size::Exact(16)), Style::Noop("text-sm")]);
									
									props.child("1", Dynamic).run("li", |mut props| {
										props.styles(vec![Style::TextColor(Color::Fg(44))]);
										
										props.child("0", Dynamic).run("span", |mut props| {
											props.styles(vec![Style::TextColor(Color::Fg(67))]);
						...
						props.child("7", Dynamic).run("div", |mut props| {
							...
							props.child("3", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::MarginTop(Size::Exact(16)), Style::SpaceY(Size::Exact(24))]);
								
								props.child("1", Dynamic).run("p", |mut props| {
									props.styles(vec![Style::Noop("text-sm"), Style::TextColor(Color::Fg(67))]);
