...
impl Widget<'_> for Example34 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example34Props) {
		ctx.styles(vec![Style::Noop("")]);
		ctx.set_attribute("style", "");
		
		ctx.child("1", Dynamic).run("section", |mut props| {
			props.styles(vec![Style::Noop("relative"), Style::Noop("isolate"), Style::Noop("overflow-hidden"), Style::Noop("bg-white"), Style::PaddingX(Size::Exact(24)), Style::PaddingY(Size::Exact(96)), Style::OnScreen(Screen::Small, &[Style::PaddingY(Size::Exact(128))]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
			
			props.child("1", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::Noop("absolute"), Style::Noop("inset-0"), Style::Noop("-z-10"), Style::Noop("bg-[radial-gradient(45rem_50rem_at_top,theme(colors.indigo.100),white)]"), Style::Noop("opacity-20")]);
			});
			...
			props.child("5", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::Noop("mx-auto"), Style::Noop("max-w-2xl"), Style::OnScreen(Screen::Large, &[Style::Noop("max-w-4xl")])]);
				
				props.child("1", Dynamic).run("img", |mut props| {
					props.styles(vec![Style::Noop("mx-auto"), Style::Width(Size::Exact(48))]);
				...
				props.child("3", Dynamic).run("figure", |mut props| {
					...
					props.child("1", Dynamic).run("blockquote", |mut props| {
						props.styles(vec![Style::Noop("text-center"), Style::Noop("text-xl"), Style::FontSemibold, Style::Noop("leading-8"), Style::TextColor(Color::Fg(100)), Style::OnScreen(Screen::Small, &[Style::Noop("text-2xl")]), Style::OnScreen(Screen::Small, &[Style::Noop("leading-9")])]);
					...
					props.child("3", Dynamic).run("figcaption", |mut props| {
						...
						props.child("1", Dynamic).run("img", |mut props| {
							props.styles(vec![Style::Noop("mx-auto"), Style::Width(Size::Exact(40)), Style::Width(Size::Exact(40)), Style::Noop("rounded-full")]);
						...
						props.child("3", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::MarginTop(Size::Exact(16)), Style::Flex, Style::ItemsCenter, Style::JustifyCenter, Style::SpaceX(Size::Exact(12)), Style::Noop("text-base")]);
							...
							props.child("3", Icon).run(|props| {
								props.style(vec![Style::Noop("fill-gray-900")]);
							});
							props.child("5", Dynamic).run("div", |mut props| {
