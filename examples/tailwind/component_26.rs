...
impl Widget<'_> for Example26 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example26Props) {
		...
		ctx.child("1", Dynamic).run("div", |mut props| {
			...
			props.child("1", Dynamic).run("div", |mut props| {
				...
				props.child("3", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::Noop("mx-auto"), Style::MarginTop(Size::Exact(40)), Style::Noop("grid"), Style::Noop("max-w-2xl"), Style::Noop("grid-cols-1"), Style::Noop("gap-x-8"), Style::Noop("gap-y-16"), Style::Noop("border-t"), Style::Noop("border-gray-200"), Style::PaddingTop(Size::Exact(40)), Style::OnScreen(Screen::Small, &[Style::MarginTop(Size::Exact(64))]), Style::OnScreen(Screen::Small, &[Style::PaddingTop(Size::Exact(64))]), Style::OnScreen(Screen::Large, &[Style::MarginX(Size::Exact(0))]), Style::OnScreen(Screen::Large, &[Style::Noop("max-w-none")]), Style::OnScreen(Screen::Large, &[Style::Noop("grid-cols-3")])]);
					
					props.child("1", Dynamic).run("article", |mut props| {
						props.styles(vec![Style::Flex, Style::Noop("max-w-xl"), Style::Noop("flex-col"), Style::Noop("items-start"), Style::JustifyBetween]);
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Flex, Style::ItemsCenter, Style::Noop("gap-x-4"), Style::Noop("text-xs")]);
							...
							props.child("3", Dynamic).run("a", |mut props| {
								...
								props.styles(vec![Style::Noop("relative"), Style::Noop("z-10"), Style::Noop("rounded-full"), Style::Color(Color::Fg(6)), Style::PaddingX(Size::Exact(12)), Style::PaddingY(Size::Exact(6)), Style::Noop("font-medium"), Style::TextColor(Color::Fg(67)), Style::OnHover(&[Style::Color(Color::Fg(11))])]);
								
								props.child("0", Label).run(|props| props.text("Marketing"));
							});
						});
						props.child("3", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("group"), Style::Noop("relative")]);
							
							props.child("1", Dynamic).run("h3", |mut props| {
								props.styles(vec![Style::MarginTop(Size::Exact(12)), Style::Noop("text-lg"), Style::FontSemibold, Style::Noop("leading-6"), Style::TextColor(Color::Fg(100)), Style::NoopGroup("group-hover", &[Style::TextColor(Color::Fg(67))])]);
							...
							props.child("3", Dynamic).run("p", |mut props| {
								props.styles(vec![Style::MarginTop(Size::Exact(20)), Style::Noop("line-clamp-3"), Style::Noop("text-sm"), Style::Noop("leading-6"), Style::TextColor(Color::Fg(67))]);
						...
						props.child("5", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("relative"), Style::MarginTop(Size::Exact(32)), Style::Flex, Style::ItemsCenter, Style::Noop("gap-x-4")]);
							...
							props.child("1", Dynamic).run("img", |mut props| {
								...
								props.styles(vec![Style::Width(Size::Exact(40)), Style::Width(Size::Exact(40)), Style::Noop("rounded-full"), Style::Color(Color::Fg(6))]);
							});
							props.child("3", Dynamic).run("div", |mut props| {
