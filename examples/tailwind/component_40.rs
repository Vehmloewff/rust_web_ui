...
impl Widget<'_> for Example40 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example40Props) {
		ctx.styles(vec![Style::Noop("")]);
		ctx.set_attribute("style", "");
		
		ctx.child("1", Dynamic).run("div", |mut props| {
			props.styles(vec![Style::Noop("min-h-[640px]"), Style::Noop("bg-white")]);
			...
			props.child("1", Dynamic).run("header", |mut props| {
				...
				props.child("1", Dynamic).run("nav", |mut props| {
					props.styles(vec![Style::Noop("mx-auto"), Style::Flex, Style::Noop("max-w-7xl"), Style::ItemsCenter, Style::JustifyBetween, Style::Padding(Size::Exact(24)), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
					props.set_attribute("aria-label", "Global");
					
					props.child("1", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Flex, Style::OnScreen(Screen::Large, &[Style::Noop("flex-1")])]);
						
						props.child("1", Dynamic).run("a", |mut props| {
							props.set_attribute("href", "#");
							props.styles(vec![Style::Noop("-m-1.5"), Style::Padding(Size::Exact(6))]);
					...
					props.child("3", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Flex, Style::OnScreen(Screen::Large, &[Style::Noop("hidden")])]);
						
						props.child("1", Dynamic).run("button", |mut props| {
							props.set_attribute("type", "button");
							props.styles(vec![Style::Noop("-m-2.5"), Style::InlineFlex, Style::ItemsCenter, Style::JustifyCenter, Style::Noop("rounded-md"), Style::Padding(Size::Exact(10)), Style::TextColor(Color::Fg(78))]);
					...
					props.child("5", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Noop("hidden"), Style::OnScreen(Screen::Large, &[Style::Flex]), Style::OnScreen(Screen::Large, &[Style::Noop("gap-x-12")])]);
						props.set_attribute("x-data", "Components.popoverGroup()");
						props.set_attribute("x-init", "init()");
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("relative")]);
							...
							props.child("1", Dynamic).run("button", |mut props| {
								props.set_attribute("type", "button");
								props.styles(vec![Style::Flex, Style::ItemsCenter, Style::Noop("gap-x-1"), Style::Noop("text-sm"), Style::FontSemibold, Style::Noop("leading-6"), Style::TextColor(Color::Fg(100))]);
								...
								props.child("1", Icon).run(|props| {
									props.style(vec![Style::Width(Size::Exact(20)), Style::Width(Size::Exact(20)), Style::Noop("flex-none"), Style::TextColor(Color::Fg(44))]);
								});
							});
							props.child("3", Dynamic).run("div", |mut props| {
								...
								props.styles(vec![Style::Noop("absolute"), Style::Noop("-left-8"), Style::Noop("top-full"), Style::Noop("z-10"), Style::MarginTop(Size::Exact(12)), Style::Noop("w-screen"), Style::Noop("max-w-md"), Style::Noop("overflow-hidden"), Style::Noop("rounded-3xl"), Style::Noop("bg-white"), Style::Noop("shadow-lg"), Style::Noop("ring-1"), Style::Noop("ring-gray-900/5")]);
								props.set_attribute("x-ref", "panel");
								props.set_attribute("@click.away", "open = false");
								
								props.child("1", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Padding(Size::Exact(16))]);
									
									props.child("1", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Noop("group"), Style::Noop("relative"), Style::Flex, Style::ItemsCenter, Style::Noop("gap-x-6"), Style::Noop("rounded-lg"), Style::Padding(Size::Exact(16)), Style::Noop("text-sm"), Style::Noop("leading-6"), Style::OnHover(&[Style::Color(Color::Fg(6))])]);
										
										props.child("1", Dynamic).run("div", |mut props| {
											props.styles(vec![Style::Flex, Style::Width(Size::Exact(44)), Style::Width(Size::Exact(44)), Style::Noop("flex-none"), Style::ItemsCenter, Style::JustifyCenter, Style::Noop("rounded-lg"), Style::Color(Color::Fg(6)), Style::NoopGroup("group-hover", &[Style::Noop("bg-white")])]);
											
											props.child("1", Icon).run(|props| {
												props.style(vec![Style::Width(Size::Exact(24)), Style::Width(Size::Exact(24)), Style::TextColor(Color::Fg(67)), Style::NoopGroup("group-hover", &[Style::Noop("text-indigo-600")])]);
											});
										});
										props.child("3", Dynamic).run("div", |mut props| {
											props.styles(vec![Style::Noop("flex-auto")]);
											
											props.child("1", Dynamic).run("a", |mut props| {
												props.set_attribute("href", "#");
												props.styles(vec![Style::Block, Style::FontSemibold, Style::TextColor(Color::Fg(100))]);
												
												props.child("0", Label).run(|props| props.text("Analytics"));
												props.child("1", Dynamic).run("span", |mut props| {
													props.styles(vec![Style::Noop("absolute"), Style::Noop("inset-0")]);
												});
											});
											props.child("3", Dynamic).run("p", |mut props| {
												props.styles(vec![Style::MarginTop(Size::Exact(4)), Style::TextColor(Color::Fg(67))]);
								...
								props.child("3", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Noop("grid"), Style::Noop("grid-cols-2"), Style::Noop("divide-x"), Style::Noop("divide-gray-900/5"), Style::Color(Color::Fg(6))]);
									
									props.child("1", Dynamic).run("a", |mut props| {
										props.set_attribute("href", "#");
										props.styles(vec![Style::Flex, Style::ItemsCenter, Style::JustifyCenter, Style::Noop("gap-x-2.5"), Style::Padding(Size::Exact(12)), Style::Noop("text-sm"), Style::FontSemibold, Style::Noop("leading-6"), Style::TextColor(Color::Fg(100)), Style::OnHover(&[Style::Color(Color::Fg(11))])]);
					...
					props.child("7", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Noop("hidden"), Style::OnScreen(Screen::Large, &[Style::Flex]), Style::OnScreen(Screen::Large, &[Style::Noop("flex-1")]), Style::OnScreen(Screen::Large, &[Style::Noop("justify-end")])]);
				...
				props.child("3", Dynamic).run("div", |mut props| {
					...
					props.styles(vec![Style::OnScreen(Screen::Large, &[Style::Noop("hidden")])]);
					...
					props.child("3", Dynamic).run("div", |mut props| {
						...
						props.child("1", Dynamic).run("div", |mut props| {
							...
							props.child("3", Dynamic).run("button", |mut props| {
								props.set_attribute("type", "button");
								props.styles(vec![Style::Noop("-m-2.5"), Style::Noop("rounded-md"), Style::Padding(Size::Exact(10)), Style::TextColor(Color::Fg(78))]);
						...
						props.child("3", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::MarginTop(Size::Exact(24)), Style::Noop("flow-root")]);
							
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Noop("-my-6"), Style::Noop("divide-y"), Style::Noop("divide-gray-500/10")]);
								
								props.child("1", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::SpaceY(Size::Exact(8)), Style::PaddingY(Size::Exact(24))]);
									
									props.child("1", Dynamic).run("div", |mut props| {
										props.set_attribute("x-data", "{ open: false }");
										props.styles(vec![Style::Noop("-mx-3")]);
										...
										props.child("1", Dynamic).run("button", |mut props| {
											...
											props.child("0", Label).run(|props| props.text("Product"));
											props.child("1", Icon).run(|props| {
												props.style(vec![Style::Width(Size::Exact(20)), Style::Width(Size::Exact(20)), Style::Noop("flex-none")]);
											});
										});
										props.child("3", Dynamic).run("div", |mut props| {
											props.styles(vec![Style::MarginTop(Size::Exact(8)), Style::SpaceY(Size::Exact(8))]);
											...
											props.child("1", Dynamic).run("a", |mut props| {
												props.set_attribute("href", "#");
												props.styles(vec![Style::Block, Style::Noop("rounded-lg"), Style::PaddingY(Size::Exact(8)), Style::PaddingLeft(Size::Exact(24)), Style::PaddingRight(Size::Exact(12)), Style::Noop("text-sm"), Style::FontSemibold, Style::Noop("leading-7"), Style::TextColor(Color::Fg(100)), Style::OnHover(&[Style::Color(Color::Fg(6))])]);
									...
									props.child("3", Dynamic).run("a", |mut props| {
										props.set_attribute("href", "#");
										props.styles(vec![Style::Noop("-mx-3"), Style::Block, Style::Noop("rounded-lg"), Style::PaddingX(Size::Exact(12)), Style::PaddingY(Size::Exact(8)), Style::Noop("text-base"), Style::FontSemibold, Style::Noop("leading-7"), Style::TextColor(Color::Fg(100)), Style::OnHover(&[Style::Color(Color::Fg(6))])]);
								...
								props.child("3", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::PaddingY(Size::Exact(24))]);
									
									props.child("1", Dynamic).run("a", |mut props| {
										props.set_attribute("href", "#");
										props.styles(vec![Style::Noop("-mx-3"), Style::Block, Style::Noop("rounded-lg"), Style::PaddingX(Size::Exact(12)), Style::PaddingY(Size::Exact(10)), Style::Noop("text-base"), Style::FontSemibold, Style::Noop("leading-7"), Style::TextColor(Color::Fg(100)), Style::OnHover(&[Style::Color(Color::Fg(6))])]);
