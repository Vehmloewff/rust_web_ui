...
impl Widget<'_> for Example23 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example23Props) {
		...
		ctx.child("1", Dynamic).run("div", |mut props| {
			...
			props.child("1", Dynamic).run("div", |mut props| {
				...
				props.child("3", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::Noop("grid"), Style::Noop("grid-cols-1"), Style::Noop("gap-x-6"), Style::Noop("gap-y-10"), Style::OnScreen(Screen::Small, &[Style::Noop("grid-cols-2")]), Style::OnScreen(Screen::Large, &[Style::Noop("grid-cols-3")]), Style::OnScreen(Screen::ExtraLarge(1), &[Style::Noop("grid-cols-4")]), Style::OnScreen(Screen::ExtraLarge(1), &[Style::Noop("gap-x-8")])]);
					
					props.child("1", Dynamic).run("a", |mut props| {
						props.set_attribute("href", "#");
						props.styles(vec![Style::Noop("group")]);
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("aspect-h-1"), Style::Noop("aspect-w-1"), Style::Width(Size::Full), Style::Noop("overflow-hidden"), Style::Noop("rounded-lg"), Style::Color(Color::Fg(22)), Style::OnScreen(Screen::ExtraLarge(1), &[Style::Noop("aspect-h-8")]), Style::OnScreen(Screen::ExtraLarge(1), &[Style::Noop("aspect-w-7")])]);
							...
							props.child("1", Dynamic).run("img", |mut props| {
								...
								props.styles(vec![Style::Width(Size::Full), Style::Width(Size::Full), Style::Noop("object-cover"), Style::Noop("object-center"), Style::NoopGroup("group-hover", &[Style::Noop("opacity-75")])]);
							});
						});
						props.child("3", Dynamic).run("h3", |mut props| {
							props.styles(vec![Style::MarginTop(Size::Exact(16)), Style::Noop("text-sm"), Style::TextColor(Color::Fg(78))]);
							
							props.child("0", Label).run(|props| props.text("Earthen Bottle"));
						});
						props.child("5", Dynamic).run("p", |mut props| {
							props.styles(vec![Style::MarginTop(Size::Exact(4)), Style::Noop("text-lg"), Style::Noop("font-medium"), Style::TextColor(Color::Fg(100))]);
