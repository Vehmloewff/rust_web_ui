...
impl Widget<'_> for Example13 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example13Props) {
		ctx.styles(vec![Style::Noop("")]);
		ctx.set_attribute("style", "");
		
		ctx.child("1", Dynamic).run("div", |mut props| {
			props.styles(vec![Style::Color(Color::Fg(33))]);
			...
			props.child("1", Dynamic).run("div", |mut props| {
				...
				props.child("3", Dynamic).run("div", |mut props| {
					...
					props.child("1", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Flex, Style::Noop("min-h-full"), Style::Noop("items-end"), Style::JustifyCenter, Style::Padding(Size::Exact(16)), Style::Noop("text-center"), Style::OnScreen(Screen::Small, &[Style::ItemsCenter]), Style::OnScreen(Screen::Small, &[Style::Padding(Size::Exact(0))])]);
						...
						props.child("1", Dynamic).run("div", |mut props| {
							...
							props.styles(vec![Style::Noop("relative"), Style::Noop("transform"), Style::Noop("overflow-hidden"), Style::Noop("rounded-lg"), Style::Noop("bg-white"), Style::Noop("text-left"), Style::Noop("shadow-xl"), Style::Noop("transition-all"), Style::OnScreen(Screen::Small, &[Style::MarginY(Size::Exact(32))]), Style::OnScreen(Screen::Small, &[Style::Width(Size::Full)]), Style::OnScreen(Screen::Small, &[Style::Noop("max-w-lg")])]);
							props.set_attribute("@click.away", "open = false");
							
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Noop("bg-white"), Style::PaddingX(Size::Exact(16)), Style::PaddingBottom(Size::Exact(16)), Style::PaddingTop(Size::Exact(20)), Style::OnScreen(Screen::Small, &[Style::Padding(Size::Exact(24))]), Style::OnScreen(Screen::Small, &[Style::PaddingBottom(Size::Exact(16))])]);
								
								props.child("1", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::OnScreen(Screen::Small, &[Style::Flex]), Style::OnScreen(Screen::Small, &[Style::Noop("items-start")])]);
									
									props.child("1", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Noop("mx-auto"), Style::Flex, Style::Width(Size::Exact(48)), Style::Width(Size::Exact(48)), Style::Noop("flex-shrink-0"), Style::ItemsCenter, Style::JustifyCenter, Style::Noop("rounded-full"), Style::Color(Color::Danger(11)), Style::OnScreen(Screen::Small, &[Style::MarginX(Size::Exact(0))]), Style::OnScreen(Screen::Small, &[Style::Width(Size::Exact(40))]), Style::OnScreen(Screen::Small, &[Style::Width(Size::Exact(40))])]);
										
										props.child("1", Icon).run(|props| {
											props.style(vec![Style::Width(Size::Exact(24)), Style::Width(Size::Exact(24)), Style::TextColor(Color::Danger(67))]);
										});
									});
									props.child("3", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::MarginTop(Size::Exact(12)), Style::Noop("text-center"), Style::OnScreen(Screen::Small, &[Style::MarginLeft(Size::Exact(16))]), Style::OnScreen(Screen::Small, &[Style::MarginTop(Size::Exact(0))]), Style::OnScreen(Screen::Small, &[Style::Noop("text-left")])]);
										...
										props.child("3", Dynamic).run("div", |mut props| {
											...
											props.child("1", Dynamic).run("p", |mut props| {
												props.styles(vec![Style::Noop("text-sm"), Style::TextColor(Color::Fg(56))]);
							...
							props.child("3", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Color(Color::Fg(6)), Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(12)), Style::OnScreen(Screen::Small, &[Style::Flex]), Style::OnScreen(Screen::Small, &[Style::Noop("flex-row-reverse")]), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))])]);
