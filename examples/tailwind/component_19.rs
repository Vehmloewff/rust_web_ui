...
impl Widget<'_> for Example19 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example19Props) {
		...
		ctx.child("1", Dynamic).run("div", |mut props| {
			...
			props.child("1", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::Noop("mx-auto"), Style::Noop("grid"), Style::Noop("max-w-2xl"), Style::Noop("grid-cols-1"), Style::ItemsCenter, Style::Noop("gap-x-8"), Style::Noop("gap-y-16"), Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(96)), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))]), Style::OnScreen(Screen::Small, &[Style::PaddingY(Size::Exact(128))]), Style::OnScreen(Screen::Large, &[Style::Noop("max-w-7xl")]), Style::OnScreen(Screen::Large, &[Style::Noop("grid-cols-2")]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
				...
				props.child("1", Dynamic).run("div", |mut props| {
					...
					props.child("3", Dynamic).run("p", |mut props| {
						props.styles(vec![Style::MarginTop(Size::Exact(16)), Style::TextColor(Color::Fg(56))]);
					...
					props.child("5", Dynamic).run("dl", |mut props| {
						props.styles(vec![Style::MarginTop(Size::Exact(64)), Style::Noop("grid"), Style::Noop("grid-cols-1"), Style::Noop("gap-x-6"), Style::Noop("gap-y-10"), Style::OnScreen(Screen::Small, &[Style::Noop("grid-cols-2")]), Style::OnScreen(Screen::Small, &[Style::Noop("gap-y-16")]), Style::OnScreen(Screen::Large, &[Style::Noop("gap-x-8")])]);
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("border-t"), Style::Noop("border-gray-200"), Style::PaddingTop(Size::Exact(16))]);
							...
							props.child("3", Dynamic).run("dd", |mut props| {
								props.styles(vec![Style::MarginTop(Size::Exact(8)), Style::Noop("text-sm"), Style::TextColor(Color::Fg(56))]);
				...
				props.child("3", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::Noop("grid"), Style::Noop("grid-cols-2"), Style::Noop("grid-rows-2"), Style::Noop("gap-4"), Style::OnScreen(Screen::Small, &[Style::Noop("gap-6")]), Style::OnScreen(Screen::Large, &[Style::Noop("gap-8")])]);
					...
					props.child("1", Dynamic).run("img", |mut props| {
						...
						props.styles(vec![Style::Noop("rounded-lg"), Style::Color(Color::Fg(11))]);
					});
