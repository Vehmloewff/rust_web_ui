...
impl Widget<'_> for Example29 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example29Props) {
		...
		ctx.child("1", Dynamic).run("div", |mut props| {
			...
			props.child("1", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::Noop("mx-auto"), Style::Noop("grid"), Style::Noop("max-w-7xl"), Style::Noop("gap-x-8"), Style::Noop("gap-y-20"), Style::PaddingX(Size::Exact(24)), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))]), Style::OnScreen(Screen::ExtraLarge(1), &[Style::Noop("grid-cols-3")])]);
				
				props.child("1", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::Noop("max-w-2xl")]);
				...
				props.child("3", Dynamic).run("ul", |mut props| {
					...
					props.styles(vec![Style::Noop("grid"), Style::Noop("gap-x-8"), Style::Noop("gap-y-12"), Style::OnScreen(Screen::Small, &[Style::Noop("grid-cols-2")]), Style::OnScreen(Screen::Small, &[Style::Noop("gap-y-16")]), Style::OnScreen(Screen::ExtraLarge(1), &[Style::Noop("col-span-2")])]);
					
					props.child("1", Dynamic).run("li", |mut props| {
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Flex, Style::ItemsCenter, Style::Noop("gap-x-6")]);
							
							props.child("1", Dynamic).run("img", |mut props| {
								props.styles(vec![Style::Width(Size::Exact(64)), Style::Width(Size::Exact(64)), Style::Noop("rounded-full")]);
							...
							props.child("3", Dynamic).run("div", |mut props| {
								props.child("1", Dynamic).run("h3", |mut props| {
									props.styles(vec![Style::Noop("text-base"), Style::FontSemibold, Style::Noop("leading-7"), Style::Noop("tracking-tight"), Style::TextColor(Color::Fg(100))]);
									
									props.child("0", Label).run(|props| props.text("Leslie Alexander"));
								});
								props.child("3", Dynamic).run("p", |mut props| {
									props.styles(vec![Style::Noop("text-sm"), Style::FontSemibold, Style::Noop("leading-6"), Style::Noop("text-indigo-600")]);
