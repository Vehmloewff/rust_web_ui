...
impl Widget<'_> for Example16 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example16Props) {
		...
		ctx.child("1", Dynamic).run("div", |mut props| {
			...
			props.child("1", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::Noop("mx-auto"), Style::Noop("max-w-2xl"), Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(64)), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))]), Style::OnScreen(Screen::Small, &[Style::PaddingY(Size::Exact(96))]), Style::OnScreen(Screen::Large, &[Style::Noop("max-w-7xl")]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
				...
				props.child("3", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::MarginTop(Size::Exact(24)), Style::Noop("grid"), Style::Noop("grid-cols-1"), Style::Noop("gap-x-6"), Style::Noop("gap-y-10"), Style::OnScreen(Screen::Small, &[Style::Noop("grid-cols-2")]), Style::OnScreen(Screen::Large, &[Style::Noop("grid-cols-4")]), Style::OnScreen(Screen::ExtraLarge(1), &[Style::Noop("gap-x-8")])]);
					
					props.child("1", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Noop("group"), Style::Noop("relative")]);
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("aspect-h-1"), Style::Noop("aspect-w-1"), Style::Width(Size::Full), Style::Noop("overflow-hidden"), Style::Noop("rounded-md"), Style::Color(Color::Fg(22)), Style::OnScreen(Screen::Large, &[Style::Noop("aspect-none")]), Style::NoopGroup("group-hover", &[Style::Noop("opacity-75")]), Style::OnScreen(Screen::Large, &[Style::Width(Size::Exact(320))])]);
							...
							props.child("1", Dynamic).run("img", |mut props| {
								...
								props.styles(vec![Style::Width(Size::Full), Style::Width(Size::Full), Style::Noop("object-cover"), Style::Noop("object-center"), Style::OnScreen(Screen::Large, &[Style::Width(Size::Full)]), Style::OnScreen(Screen::Large, &[Style::Width(Size::Full)])]);
							});
						});
						props.child("3", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::MarginTop(Size::Exact(16)), Style::Flex, Style::JustifyBetween]);
