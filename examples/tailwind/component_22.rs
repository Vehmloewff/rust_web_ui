...
impl Widget<'_> for Example22 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example22Props) {
		ctx.styles(vec![Style::Noop("")]);
		ctx.set_attribute("style", "");
		
		ctx.child("1", Dynamic).run("div", |mut props| {
			props.styles(vec![Style::Noop("min-h-[768px]"), Style::Color(Color::Fg(11))]);
			...
			props.child("1", Dynamic).run("div", |mut props| {
				...
				props.child("1", Dynamic).run("div", |mut props| {
					...
					props.styles(vec![Style::Noop("fixed"), Style::Noop("inset-0"), Style::Color(Color::Fg(56)), Style::Noop("bg-opacity-75"), Style::Noop("transition-opacity")]);
				});
				props.child("3", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::Noop("fixed"), Style::Noop("inset-0"), Style::Noop("overflow-hidden")]);
					
					props.child("1", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Noop("absolute"), Style::Noop("inset-0"), Style::Noop("overflow-hidden")]);
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("pointer-events-none"), Style::Noop("fixed"), Style::Noop("inset-y-0"), Style::Noop("right-0"), Style::Flex, Style::Noop("max-w-full"), Style::PaddingLeft(Size::Exact(40))]);
							...
							props.child("1", Dynamic).run("div", |mut props| {
								...
								props.styles(vec![Style::Noop("pointer-events-auto"), Style::Noop("w-screen"), Style::Noop("max-w-md")]);
								...
								props.child("1", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Flex, Style::Width(Size::Full), Style::Noop("flex-col"), Style::Noop("overflow-y-scroll"), Style::Noop("bg-white"), Style::Noop("shadow-xl")]);
									
									props.child("1", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Noop("flex-1"), Style::Noop("overflow-y-auto"), Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(24)), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))])]);
										
										props.child("1", Dynamic).run("div", |mut props| {
											props.styles(vec![Style::Flex, Style::Noop("items-start"), Style::JustifyBetween]);
											...
											props.child("3", Dynamic).run("div", |mut props| {
												props.styles(vec![Style::MarginLeft(Size::Exact(12)), Style::Flex, Style::Width(Size::Exact(28)), Style::ItemsCenter]);
												
												props.child("1", Dynamic).run("button", |mut props| {
													props.set_attribute("type", "button");
													props.styles(vec![Style::Noop("relative"), Style::Noop("-m-2"), Style::Padding(Size::Exact(8)), Style::TextColor(Color::Fg(44)), Style::OnHover(&[Style::TextColor(Color::Fg(56))])]);
										...
										props.child("3", Dynamic).run("div", |mut props| {
											...
											props.child("1", Dynamic).run("div", |mut props| {
												...
												props.child("1", Dynamic).run("ul", |mut props| {
													...
													props.styles(vec![Style::Noop("-my-6"), Style::Noop("divide-y"), Style::Noop("divide-gray-200")]);
													
													props.child("1", Dynamic).run("li", |mut props| {
														props.styles(vec![Style::Flex, Style::PaddingY(Size::Exact(24))]);
														
														props.child("1", Dynamic).run("div", |mut props| {
															props.styles(vec![Style::Width(Size::Exact(96)), Style::Width(Size::Exact(96)), Style::Noop("flex-shrink-0"), Style::Noop("overflow-hidden"), Style::Noop("rounded-md"), Style::Noop("border"), Style::Noop("border-gray-200")]);
														...
														props.child("3", Dynamic).run("div", |mut props| {
															props.styles(vec![Style::MarginLeft(Size::Exact(16)), Style::Flex, Style::Noop("flex-1"), Style::Noop("flex-col")]);
															
															props.child("1", Dynamic).run("div", |mut props| {
																props.child("1", Dynamic).run("div", |mut props| {
																	props.styles(vec![Style::Flex, Style::JustifyBetween, Style::Noop("text-base"), Style::Noop("font-medium"), Style::TextColor(Color::Fg(100))]);
																	
																	props.child("1", Dynamic).run("h3", |mut props| {
																		props.child("1", Dynamic).run("a", |_| {});
																	});
																	props.child("3", Dynamic).run("p", |mut props| {
																		props.styles(vec![Style::MarginLeft(Size::Exact(16))]);
																		
																		props.child("0", Label).run(|props| props.text("$90.00"));
																	});
																});
																props.child("3", Dynamic).run("p", |mut props| {
																	props.styles(vec![Style::MarginTop(Size::Exact(4)), Style::Noop("text-sm"), Style::TextColor(Color::Fg(56))]);
																	
																	props.child("0", Label).run(|props| props.text("Salmon"));
																});
															});
															props.child("3", Dynamic).run("div", |mut props| {
																props.styles(vec![Style::Flex, Style::Noop("flex-1"), Style::Noop("items-end"), Style::JustifyBetween, Style::Noop("text-sm")]);
																...
																props.child("3", Dynamic).run("div", |mut props| {
																	...
																	props.child("1", Dynamic).run("button", |mut props| {
																		props.set_attribute("type", "button");
																		props.styles(vec![Style::Noop("font-medium"), Style::Noop("text-indigo-600"), Style::OnHover(&[Style::Noop("text-indigo-500")])]);
									...
									props.child("3", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Noop("border-t"), Style::Noop("border-gray-200"), Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(24)), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))])]);
										...
										props.child("3", Dynamic).run("p", |mut props| {
											props.styles(vec![Style::MarginTop(Size::Exact(2)), Style::Noop("text-sm"), Style::TextColor(Color::Fg(56))]);
										...
										props.child("5", Dynamic).run("div", |mut props| {
											...
											props.child("1", Dynamic).run("a", |mut props| {
												...
												props.styles(vec![Style::Flex, Style::ItemsCenter, Style::JustifyCenter, Style::Noop("rounded-md"), Style::Noop("border"), Style::Noop("border-transparent"), Style::Noop("bg-indigo-600"), Style::PaddingX(Size::Exact(24)), Style::PaddingY(Size::Exact(12)), Style::Noop("text-base"), Style::Noop("font-medium"), Style::Noop("text-white"), Style::Noop("shadow-sm"), Style::OnHover(&[Style::Noop("bg-indigo-700")])]);
												
												props.child("0", Label).run(|props| props.text("Checkout"));
											});
										});
										props.child("7", Dynamic).run("div", |mut props| {
											props.styles(vec![Style::MarginTop(Size::Exact(24)), Style::Flex, Style::JustifyCenter, Style::Noop("text-center"), Style::Noop("text-sm"), Style::TextColor(Color::Fg(56))]);
