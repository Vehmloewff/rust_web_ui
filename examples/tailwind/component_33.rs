...
impl Widget<'_> for Example33 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example33Props) {
		ctx.styles(vec![Style::Noop("")]);
		ctx.set_attribute("style", "");
		
		ctx.child("1", Dynamic).run("div", |mut props| {
			props.styles(vec![Style::Noop("isolate"), Style::Noop("bg-white"), Style::PaddingX(Size::Exact(24)), Style::PaddingY(Size::Exact(96)), Style::OnScreen(Screen::Small, &[Style::PaddingY(Size::Exact(128))]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
			
			props.child("1", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::Noop("absolute"), Style::Noop("inset-x-0"), Style::Noop("top-[-10rem]"), Style::Noop("-z-10"), Style::Noop("transform-gpu"), Style::Noop("overflow-hidden"), Style::Noop("blur-3xl"), Style::OnScreen(Screen::Small, &[Style::Noop("top-[-20rem]")])]);
				props.set_attribute("aria-hidden", "true");
				
				props.child("1", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::Noop("relative"), Style::Noop("left-1/2"), Style::Noop("-z-10"), Style::Noop("aspect-[1155/678]"), Style::Noop("w-[36.125rem]"), Style::Noop("max-w-none"), Style::Noop("-translate-x-1/2"), Style::Noop("rotate-[30deg]"), Style::Noop("bg-gradient-to-tr"), Style::Noop("from-[#ff80b5]"), Style::Noop("to-[#9089fc]"), Style::Noop("opacity-30"), Style::OnScreen(Screen::Small, &[Style::Noop("left-[calc(50%-40rem)]")]), Style::OnScreen(Screen::Small, &[Style::Noop("w-[72.1875rem]")])]);
			...
			props.child("3", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::Noop("mx-auto"), Style::Noop("max-w-2xl"), Style::Noop("text-center")]);
				...
				props.child("3", Dynamic).run("p", |mut props| {
					props.styles(vec![Style::MarginTop(Size::Exact(8)), Style::Noop("text-lg"), Style::Noop("leading-8"), Style::TextColor(Color::Fg(67))]);
			...
			props.child("5", Dynamic).run("form", |mut props| {
				...
				props.styles(vec![Style::Noop("mx-auto"), Style::MarginTop(Size::Exact(64)), Style::Noop("max-w-xl"), Style::OnScreen(Screen::Small, &[Style::MarginTop(Size::Exact(80))])]);
				
				props.child("1", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::Noop("grid"), Style::Noop("grid-cols-1"), Style::Noop("gap-x-8"), Style::Noop("gap-y-6"), Style::OnScreen(Screen::Small, &[Style::Noop("grid-cols-2")])]);
					
					props.child("1", Dynamic).run("div", |mut props| {
						props.child("1", Dynamic).run("label", |mut props| {
							props.set_attribute("for", "first-name");
							props.styles(vec![Style::Block, Style::Noop("text-sm"), Style::FontSemibold, Style::Noop("leading-6"), Style::TextColor(Color::Fg(100))]);
							
							props.child("0", Label).run(|props| props.text("First name"));
						});
						props.child("3", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::MarginTop(Size::Exact(10))]);
					...
					props.child("9", Dynamic).run("div", |mut props| {
						...
						props.child("3", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("relative"), Style::MarginTop(Size::Exact(10))]);
							
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Noop("absolute"), Style::Noop("inset-y-0"), Style::Noop("left-0"), Style::Flex, Style::ItemsCenter]);
								...
								props.child("5", Icon).run(|props| {
									props.style(vec![Style::Noop("pointer-events-none"), Style::Noop("absolute"), Style::Noop("right-3"), Style::Noop("top-0"), Style::Width(Size::Full), Style::Width(Size::Exact(20)), Style::TextColor(Color::Fg(44))]);
								});
							});
					...
					props.child("13", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Flex, Style::Noop("gap-x-4"), Style::OnScreen(Screen::Small, &[Style::Noop("col-span-2")])]);
						...
						props.child("1", Dynamic).run("div", |mut props| {
							...
							props.child("1", Dynamic).run("button", |mut props| {
								...
								props.child("3", Dynamic).run("span", |mut props| {
									props.set_attribute("aria-hidden", "true");
									props.styles(vec![Style::Noop("translate-x-0"), Style::Width(Size::Exact(16)), Style::Width(Size::Exact(16)), Style::Noop("transform"), Style::Noop("rounded-full"), Style::Noop("bg-white"), Style::Noop("shadow-sm"), Style::Noop("ring-1"), Style::Noop("ring-gray-900/5"), Style::Noop("transition"), Style::Noop("duration-200"), Style::Noop("ease-in-out")]);
									props.set_attribute("x-state:on", "Enabled");
									props.set_attribute("x-state:off", "Not Enabled");
						...
						props.child("3", Dynamic).run("label", |mut props| {
							props.styles(vec![Style::Noop("text-sm"), Style::Noop("leading-6"), Style::TextColor(Color::Fg(67))]);
							...
							props.child("3", Dynamic).run("a", |mut props| {
								...
								props.styles(vec![Style::FontSemibold, Style::Noop("text-indigo-600")]);
