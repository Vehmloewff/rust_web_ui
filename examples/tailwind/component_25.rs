...
impl Widget<'_> for Example25 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example25Props) {
		ctx.styles(vec![Style::Noop("")]);
		ctx.set_attribute("style", "");
		
		ctx.child("1", Dynamic).run("div", |mut props| {
			props.styles(vec![Style::Noop("relative"), Style::Noop("overflow-hidden"), Style::Noop("bg-white")]);
			
			props.child("1", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::PaddingBottom(Size::Exact(320)), Style::PaddingTop(Size::Exact(64)), Style::OnScreen(Screen::Small, &[Style::PaddingBottom(Size::Exact(160))]), Style::OnScreen(Screen::Small, &[Style::PaddingTop(Size::Exact(96))]), Style::OnScreen(Screen::Large, &[Style::PaddingBottom(Size::Exact(192))]), Style::OnScreen(Screen::Large, &[Style::PaddingTop(Size::Exact(160))])]);
				
				props.child("1", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::Noop("relative"), Style::Noop("mx-auto"), Style::Noop("max-w-7xl"), Style::PaddingX(Size::Exact(16)), Style::OnScreen(Screen::Small, &[Style::Noop("static")]), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
					
					props.child("1", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::OnScreen(Screen::Small, &[Style::Noop("max-w-lg")])]);
						
						props.child("1", Dynamic).run("h1", |mut props| {
							props.styles(vec![Style::Noop("text-4xl"), Style::FontBold, Style::Noop("tracking-tight"), Style::TextColor(Color::Fg(100)), Style::OnScreen(Screen::Small, &[Style::Noop("text-6xl")])]);
							
							props.child("0", Label).run(|props| props.text("Summer styles are finally here"));
						});
						props.child("3", Dynamic).run("p", |mut props| {
							props.styles(vec![Style::MarginTop(Size::Exact(16)), Style::Noop("text-xl"), Style::TextColor(Color::Fg(56))]);
					...
					props.child("3", Dynamic).run("div", |mut props| {
						props.child("1", Dynamic).run("div", |mut props| {
							...
							props.child("3", Dynamic).run("div", |mut props| {
								...
								props.styles(vec![Style::Noop("pointer-events-none"), Style::OnScreen(Screen::Large, &[Style::Noop("absolute")]), Style::OnScreen(Screen::Large, &[Style::Noop("inset-y-0")]), Style::OnScreen(Screen::Large, &[Style::Noop("mx-auto")]), Style::OnScreen(Screen::Large, &[Style::Width(Size::Full)]), Style::OnScreen(Screen::Large, &[Style::Noop("max-w-7xl")])]);
								...
								props.child("1", Dynamic).run("div", |mut props| {
									...
									props.child("1", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Flex, Style::ItemsCenter, Style::SpaceX(Size::Exact(24)), Style::OnScreen(Screen::Large, &[Style::SpaceX(Size::Exact(32))])]);
										
										props.child("1", Dynamic).run("div", |mut props| {
											props.styles(vec![Style::Noop("grid"), Style::Noop("flex-shrink-0"), Style::Noop("grid-cols-1"), Style::Noop("gap-y-6"), Style::OnScreen(Screen::Large, &[Style::Noop("gap-y-8")])]);
											
											props.child("1", Dynamic).run("div", |mut props| {
												props.styles(vec![Style::Width(Size::Exact(256)), Style::Width(Size::Exact(176)), Style::Noop("overflow-hidden"), Style::Noop("rounded-lg"), Style::OnScreen(Screen::Small, &[Style::Noop("opacity-0")]), Style::OnScreen(Screen::Large, &[Style::Noop("opacity-100")])]);
											...
											props.child("3", Dynamic).run("div", |mut props| {
												props.styles(vec![Style::Width(Size::Exact(256)), Style::Width(Size::Exact(176)), Style::Noop("overflow-hidden"), Style::Noop("rounded-lg")]);
							...
							props.child("5", Dynamic).run("a", |mut props| {
								...
								props.styles(vec![Style::InlineBlock, Style::Noop("rounded-md"), Style::Noop("border"), Style::Noop("border-transparent"), Style::Noop("bg-indigo-600"), Style::PaddingX(Size::Exact(32)), Style::PaddingY(Size::Exact(12)), Style::Noop("text-center"), Style::Noop("font-medium"), Style::Noop("text-white"), Style::OnHover(&[Style::Noop("bg-indigo-700")])]);
