...
impl Widget<'_> for Example9 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example9Props) {
		ctx.styles(vec![Style::Noop("")]);
		ctx.set_attribute("style", "");
		
		ctx.child("1", Dynamic).run("div", |mut props| {
			props.styles(vec![Style::Color(Color::Fg(11))]);
			...
			props.child("3", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::Noop("min-h-full")]);
				
				props.child("1", Dynamic).run("nav", |mut props| {
					props.set_attribute("x-data", "{ open: false }");
					props.styles(vec![Style::Color(Color::Fg(89))]);
					...
					props.child("1", Dynamic).run("div", |mut props| {
						...
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Flex, Style::Width(Size::Exact(64)), Style::ItemsCenter, Style::JustifyBetween]);
							
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Flex, Style::ItemsCenter]);
								
								props.child("1", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Noop("flex-shrink-0")]);
									
									props.child("1", Dynamic).run("img", |mut props| {
										props.styles(vec![Style::Width(Size::Exact(32)), Style::Width(Size::Exact(32))]);
								...
								props.child("3", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Noop("hidden"), Style::OnScreen(Screen::Medium, &[Style::Block])]);
									
									props.child("1", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::MarginLeft(Size::Exact(40)), Style::Flex, Style::Noop("items-baseline"), Style::SpaceX(Size::Exact(16))]);
										
										props.child("1", Dynamic).run("a", |mut props| {
											props.set_attribute("href", "#");
											props.styles(vec![Style::Color(Color::Fg(100)), Style::Noop("text-white"), Style::Noop("rounded-md"), Style::PaddingX(Size::Exact(12)), Style::PaddingY(Size::Exact(8)), Style::Noop("text-sm"), Style::Noop("font-medium")]);
										...
										props.child("3", Dynamic).run("a", |mut props| {
											props.set_attribute("href", "#");
											props.styles(vec![Style::TextColor(Color::Fg(33)), Style::OnHover(&[Style::Color(Color::Fg(78))]), Style::OnHover(&[Style::Noop("text-white")]), Style::Noop("rounded-md"), Style::PaddingX(Size::Exact(12)), Style::PaddingY(Size::Exact(8)), Style::Noop("text-sm"), Style::Noop("font-medium")]);
							...
							props.child("3", Dynamic).run("div", |mut props| {
								...
								props.child("1", Dynamic).run("div", |mut props| {
									...
									props.child("5", Dynamic).run("div", |mut props| {
										...
										props.styles(vec![Style::Noop("relative"), Style::MarginLeft(Size::Exact(12))]);
										
										props.child("1", Dynamic).run("div", |mut props| {
											props.child("1", Dynamic).run("button", |mut props| {
												props.set_attribute("type", "button");
												props.styles(vec![Style::Noop("relative"), Style::Flex, Style::Noop("max-w-xs"), Style::ItemsCenter, Style::Noop("rounded-full"), Style::Color(Color::Fg(89)), Style::Noop("text-sm"), Style::OnFocus(&[Style::Noop("outline-none")]), Style::OnFocus(&[Style::Noop("ring-2")]), Style::OnFocus(&[Style::Noop("ring-white")]), Style::OnFocus(&[Style::Noop("ring-offset-2")]), Style::OnFocus(&[Style::Noop("ring-offset-gray-800")])]);
												...
												props.child("5", Dynamic).run("img", |mut props| {
													props.styles(vec![Style::Width(Size::Exact(32)), Style::Width(Size::Exact(32)), Style::Noop("rounded-full")]);
										...
										props.child("3", Dynamic).run("div", |mut props| {
											...
											props.child("1", Dynamic).run("a", |mut props| {
												props.set_attribute("href", "#");
												props.styles(vec![Style::Block, Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(8)), Style::Noop("text-sm"), Style::TextColor(Color::Fg(78))]);
							...
							props.child("5", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Noop("-mr-2"), Style::Flex, Style::OnScreen(Screen::Medium, &[Style::Noop("hidden")])]);
								
								//  Mobile menu button 
								props.child("3", Dynamic).run("button", |mut props| {
									props.set_attribute("type", "button");
									props.styles(vec![Style::Noop("relative"), Style::InlineFlex, Style::ItemsCenter, Style::JustifyCenter, Style::Noop("rounded-md"), Style::Color(Color::Fg(89)), Style::Padding(Size::Exact(8)), Style::TextColor(Color::Fg(44)), Style::OnHover(&[Style::Color(Color::Fg(78))]), Style::OnHover(&[Style::Noop("text-white")]), Style::OnFocus(&[Style::Noop("outline-none")]), Style::OnFocus(&[Style::Noop("ring-2")]), Style::OnFocus(&[Style::Noop("ring-white")]), Style::OnFocus(&[Style::Noop("ring-offset-2")]), Style::OnFocus(&[Style::Noop("ring-offset-gray-800")])]);
									...
									props.child("5", Icon).run(|props| {
										props.style(vec![Style::Block, Style::Width(Size::Exact(24)), Style::Width(Size::Exact(24))]);
									});
									props.child("7", Icon).run(|props| {
										props.style(vec![Style::Noop("hidden"), Style::Width(Size::Exact(24)), Style::Width(Size::Exact(24))]);
									});
								});
							});
						});
					...
					props.child("3", Dynamic).run("div", |mut props| {
						...
						props.styles(vec![Style::OnScreen(Screen::Medium, &[Style::Noop("hidden")])]);
						props.set_attribute("id", "mobile-menu");
						props.set_attribute("x-show", "open");
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::SpaceY(Size::Exact(4)), Style::PaddingX(Size::Exact(8)), Style::PaddingBottom(Size::Exact(12)), Style::PaddingTop(Size::Exact(8)), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(12))])]);
							
							props.child("1", Dynamic).run("a", |mut props| {
								props.set_attribute("href", "#");
								props.styles(vec![Style::Color(Color::Fg(100)), Style::Noop("text-white"), Style::Block, Style::Noop("rounded-md"), Style::PaddingX(Size::Exact(12)), Style::PaddingY(Size::Exact(8)), Style::Noop("text-base"), Style::Noop("font-medium")]);
								props.set_attribute("aria-current", "page");
								props.set_attribute("x-state:on", "Current");
								props.set_attribute("x-state:off", "Default");
								props.set_attribute("x-state-description", r#"Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white""#);
							...
							props.child("3", Dynamic).run("a", |mut props| {
								props.set_attribute("href", "#");
								props.styles(vec![Style::TextColor(Color::Fg(33)), Style::OnHover(&[Style::Color(Color::Fg(78))]), Style::OnHover(&[Style::Noop("text-white")]), Style::Block, Style::Noop("rounded-md"), Style::PaddingX(Size::Exact(12)), Style::PaddingY(Size::Exact(8)), Style::Noop("text-base"), Style::Noop("font-medium")]);
								props.set_attribute("x-state-description", r#"undefined: "bg-gray-900 text-white", undefined: "text-gray-300 hover:bg-gray-700 hover:text-white""#);
						...
						props.child("3", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("border-t"), Style::Noop("border-gray-700"), Style::PaddingBottom(Size::Exact(12)), Style::PaddingTop(Size::Exact(16))]);
							
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Flex, Style::ItemsCenter, Style::PaddingX(Size::Exact(20))]);
								
								props.child("1", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Noop("flex-shrink-0")]);
									
									props.child("1", Dynamic).run("img", |mut props| {
										props.styles(vec![Style::Width(Size::Exact(40)), Style::Width(Size::Exact(40)), Style::Noop("rounded-full")]);
										props.set_attribute("src", "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80");
										props.set_attribute("alt", "");
									});
								});
								props.child("3", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::MarginLeft(Size::Exact(12))]);
									
									props.child("1", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Noop("text-base"), Style::Noop("font-medium"), Style::Noop("leading-none"), Style::Noop("text-white")]);
										
										props.child("0", Label).run(|props| props.text("Tom Cook"));
									});
									props.child("3", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Noop("text-sm"), Style::Noop("font-medium"), Style::Noop("leading-none"), Style::TextColor(Color::Fg(44))]);
								...
								props.child("5", Dynamic).run("button", |mut props| {
									props.set_attribute("type", "button");
									props.styles(vec![Style::Noop("relative"), Style::Noop("ml-auto"), Style::Noop("flex-shrink-0"), Style::Noop("rounded-full"), Style::Color(Color::Fg(89)), Style::Padding(Size::Exact(4)), Style::TextColor(Color::Fg(44)), Style::OnHover(&[Style::Noop("text-white")]), Style::OnFocus(&[Style::Noop("outline-none")]), Style::OnFocus(&[Style::Noop("ring-2")]), Style::OnFocus(&[Style::Noop("ring-white")]), Style::OnFocus(&[Style::Noop("ring-offset-2")]), Style::OnFocus(&[Style::Noop("ring-offset-gray-800")])]);
							...
							props.child("3", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::MarginTop(Size::Exact(12)), Style::SpaceY(Size::Exact(4)), Style::PaddingX(Size::Exact(8))]);
								
								props.child("1", Dynamic).run("a", |mut props| {
									props.set_attribute("href", "#");
									props.styles(vec![Style::Block, Style::Noop("rounded-md"), Style::PaddingX(Size::Exact(12)), Style::PaddingY(Size::Exact(8)), Style::Noop("text-base"), Style::Noop("font-medium"), Style::TextColor(Color::Fg(44)), Style::OnHover(&[Style::Color(Color::Fg(78))]), Style::OnHover(&[Style::Noop("text-white")])]);
				...
				props.child("3", Dynamic).run("header", |mut props| {
					props.styles(vec![Style::Noop("bg-white"), Style::Noop("shadow")]);
					
					props.child("1", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Noop("mx-auto"), Style::Noop("max-w-7xl"), Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(24)), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
						
						props.child("1", Dynamic).run("h1", |mut props| {
							props.styles(vec![Style::Noop("text-3xl"), Style::FontBold, Style::Noop("tracking-tight"), Style::TextColor(Color::Fg(100))]);
				...
				props.child("5", Dynamic).run("main", |mut props| {
					props.child("1", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Noop("mx-auto"), Style::Noop("max-w-7xl"), Style::PaddingY(Size::Exact(24)), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
						
						props.child("1", Dynamic).run("x-placeholder", |mut props| {
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(24)), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(0))])]);
								
								props.child("1", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Noop("relative"), Style::Width(Size::Exact(384)), Style::Noop("overflow-hidden"), Style::Noop("rounded-xl"), Style::Noop("border"), Style::Noop("border-dashed"), Style::Noop("border-gray-400"), Style::Noop("opacity-75")]);
