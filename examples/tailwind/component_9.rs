	...
	fn render(mut ctx: Ctx<'_>, props: Example9Props) {
		...
		ctx.child("1", Dynamic).run("div", |props| {
			...
			props.child("3", Dynamic).run("div", |props| {
				props.styles(&[NoStyle::Noop("min-h-full")]);
				...
				props.child("1", Dynamic).run("nav", |props| {
					...
					props.child("1", Dynamic).run("div", |props| {
						...
						props.child("1", Dynamic).run("div", |props| {
							props.styles(&[Style::Flex, Style::Width(64), Style::ItemsCenter, Style::JustifyBetween]);
							
							props.child("1", Dynamic).run("div", |props| {
								props.styles(&[Style::Flex, Style::ItemsCenter]);
								
								props.child("1", Dynamic).run("div", |props| {
									props.styles(&[NoStyle::Noop("flex-shrink-0")]);
									
									props.child("1", Dynamic).run("img", |props| {
										props.styles(&[Style::Width(32), Style::Width(32)]);
								...
								props.child("3", Dynamic).run("div", |props| {
									props.styles(&[NoStyle::Noop("hidden"), Screen::Medium(&[Style::Block])]);
									
									props.child("1", Dynamic).run("div", |props| {
										props.styles(&[Style::MarginLeft(40), Style::Flex, NoStyle::Noop("items-baseline"), Style::SpaceX(16)]);
										...
										props.child("9", Dynamic).run("a", |props| {
											...
											props.child("0", Label).run(|props| props.set_text("Reports"));
										});
									});
								});
							});
							props.child("3", Dynamic).run("div", |props| {
								...
								props.child("1", Dynamic).run("div", |props| {
									props.styles(&[Style::MarginLeft(16), Style::Flex, Style::ItemsCenter, Screen::Medium(&[Style::MarginLeft(24)])]);
							...
							props.child("5", Dynamic).run("div", |props| {
								props.styles(&[NoStyle::Noop("-mr-2"), Style::Flex, Screen::Medium(&[NoStyle::Noop("hidden")])]);
								
								//  Mobile menu button 
								props.child("3", Dynamic).run("button", |props| {
									props.set_attribute("type", "button");
									props.styles(&[NoStyle::Noop("relative"), Style::InlineFlex, Style::ItemsCenter, Style::JustifyCenter, NoStyle::Noop("rounded-md"), Style::Color(Color::Fg(89)), Style::Padding(8), Style::TextColor(Color::Fg(44)), Action::Hover(&[Style::Color(Color::Fg(78))]), Action::Hover(&[NoStyle::Noop("text-white")]), Action::Hover(&[NoStyle::Noop("outline-none")]), Action::Hover(&[NoStyle::Noop("ring-2")]), Action::Hover(&[NoStyle::Noop("ring-white")]), Action::Hover(&[NoStyle::Noop("ring-offset-2")]), Action::Hover(&[NoStyle::Noop("ring-offset-gray-800")])]);
					...
					props.child("3", Dynamic).run("div", |props| {
						...
						props.styles(&[Screen::Medium(&[NoStyle::Noop("hidden")])]);
						props.set_attribute("id", "mobile-menu");
						props.set_attribute("x-show", "open");
						
						props.child("1", Dynamic).run("div", |props| {
							props.styles(&[Style::SpaceY(4), Style::PaddingX(8), Style::PaddingBottom(12), Style::PaddingTop(8), Screen::Small(&[Style::PaddingX(12)])]);
						...
						props.child("3", Dynamic).run("div", |props| {
							props.styles(&[NoStyle::Noop("border-t"), NoStyle::Noop("border-gray-700"), Style::PaddingBottom(12), Style::PaddingTop(16)]);
							
							props.child("1", Dynamic).run("div", |props| {
								props.styles(&[Style::Flex, Style::ItemsCenter, Style::PaddingX(20)]);
								
								props.child("1", Dynamic).run("div", |props| {
									props.styles(&[NoStyle::Noop("flex-shrink-0")]);
									
									props.child("1", Dynamic).run("img", |props| {
										props.styles(&[Style::Width(40), Style::Width(40), NoStyle::Noop("rounded-full")]);
										props.set_attribute("src", "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80");
										props.set_attribute("alt", "");
									});
								});
								props.child("3", Dynamic).run("div", |props| {
									props.styles(&[Style::MarginLeft(12)]);
									
									props.child("1", Dynamic).run("div", |props| {
										props.styles(&[NoStyle::Noop("text-base"), NoStyle::Noop("font-medium"), NoStyle::Noop("leading-none"), NoStyle::Noop("text-white")]);
										
										props.child("0", Label).run(|props| props.set_text("Tom Cook"));
									});
									props.child("3", Dynamic).run("div", |props| {
										props.styles(&[NoStyle::Noop("text-sm"), NoStyle::Noop("font-medium"), NoStyle::Noop("leading-none"), Style::TextColor(Color::Fg(44))]);
										
										props.child("0", Label).run(|props| props.set_text("tom@example.com"));
									});
								});
								props.child("5", Dynamic).run("button", |props| {
									props.set_attribute("type", "button");
									props.styles(&[NoStyle::Noop("relative"), NoStyle::Noop("ml-auto"), NoStyle::Noop("flex-shrink-0"), NoStyle::Noop("rounded-full"), Style::Color(Color::Fg(89)), Style::Padding(4), Style::TextColor(Color::Fg(44)), Action::Hover(&[NoStyle::Noop("text-white")]), Action::Hover(&[NoStyle::Noop("outline-none")]), Action::Hover(&[NoStyle::Noop("ring-2")]), Action::Hover(&[NoStyle::Noop("ring-white")]), Action::Hover(&[NoStyle::Noop("ring-offset-2")]), Action::Hover(&[NoStyle::Noop("ring-offset-gray-800")])]);
							...
							props.child("3", Dynamic).run("div", |props| {
								props.styles(&[Style::MarginTop(12), Style::SpaceY(4), Style::PaddingX(8)]);
								
								props.child("1", Dynamic).run("a", |props| {
									props.set_attribute("href", "#");
									props.styles(&[Style::Block, NoStyle::Noop("rounded-md"), Style::PaddingX(12), Style::PaddingY(8), NoStyle::Noop("text-base"), NoStyle::Noop("font-medium"), Style::TextColor(Color::Fg(44)), Action::Hover(&[Style::Color(Color::Fg(78))]), Action::Hover(&[NoStyle::Noop("text-white")])]);
				...
				props.child("3", Dynamic).run("header", |props| {
					props.styles(&[NoStyle::Noop("bg-white"), NoStyle::Noop("shadow")]);
					
					props.child("1", Dynamic).run("div", |props| {
						props.styles(&[NoStyle::Noop("mx-auto"), NoStyle::Noop("max-w-7xl"), Style::PaddingX(16), Style::PaddingY(24), Screen::Small(&[Style::PaddingX(24)]), Screen::Large(&[Style::PaddingX(32)])]);
						
						props.child("1", Dynamic).run("h1", |props| {
							props.styles(&[NoStyle::Noop("text-3xl"), Style::FontBold, NoStyle::Noop("tracking-tight"), Style::TextColor(Color::Fg(100))]);
				...
				props.child("5", Dynamic).run("main", |props| {
					props.child("1", Dynamic).run("div", |props| {
						...
						props.child("1", Dynamic).run("x-placeholder", |props| {
							props.child("1", Dynamic).run("div", |props| {
								props.styles(&[Style::PaddingX(16), Style::PaddingY(24), Screen::Small(&[Style::PaddingX(0)])]);
								
								props.child("1", Dynamic).run("div", |props| {
									props.styles(&[NoStyle::Noop("relative"), Style::Width(384), NoStyle::Noop("overflow-hidden"), NoStyle::Noop("rounded-xl"), NoStyle::Noop("border"), NoStyle::Noop("border-dashed"), NoStyle::Noop("border-gray-400"), NoStyle::Noop("opacity-75")]);
