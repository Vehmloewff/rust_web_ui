...
impl Widget<'_> for Example18 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example18Props) {
		ctx.styles(vec![Style::Noop("")]);
		ctx.set_attribute("style", "");
		
		ctx.child("1", Dynamic).run("div", |mut props| {
			props.styles(vec![Style::Flex, Style::Noop("min-h-[700px]")]);
			
			props.child("1", Dynamic).run("div", |mut props| {
				props.styles(vec![Style::Flex, Style::Width(Size::Full), Style::ItemsCenter, Style::JustifyCenter, Style::Noop("bg-white"), Style::PaddingX(Size::Exact(16)), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
				props.set_attribute("style", "height: 700px");
				
				props.child("1", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::Width(Size::Exact(288))]);
					...
					props.child("1", Dynamic).run("div", |mut props| {
						...
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("group"), Style::Noop("relative"), Style::Flex, Style::Noop("flex-col-reverse")]);
							
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::MarginTop(Size::Exact(16)), Style::Flex, Style::ItemsCenter, Style::JustifyBetween, Style::SpaceX(Size::Exact(32)), Style::Noop("text-base"), Style::Noop("font-medium"), Style::TextColor(Color::Fg(100))]);
								
								props.child("1", Dynamic).run("h3", |mut props| {
									props.child("1", Dynamic).run("a", |_| {});
								});
								props.child("3", Dynamic).run("p", |_| {});
							});
							props.child("3", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Noop("aspect-h-3"), Style::Noop("aspect-w-4"), Style::Noop("overflow-hidden"), Style::Noop("rounded-lg"), Style::Color(Color::Fg(11))]);
						...
						props.child("3", Dynamic).run("div", |mut props| {
							...
							props.styles(vec![Style::Noop("relative"), Style::Noop("z-10")]);
							...
							props.child("1", Dynamic).run("div", |mut props| {
								...
								props.styles(vec![Style::Noop("fixed"), Style::Noop("inset-0"), Style::Noop("hidden"), Style::Color(Color::Fg(56)), Style::Noop("bg-opacity-75"), Style::Noop("transition-opacity"), Style::OnScreen(Screen::Medium, &[Style::Block])]);
							});
							props.child("3", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Noop("fixed"), Style::Noop("inset-0"), Style::Noop("z-10"), Style::Noop("w-screen"), Style::Noop("overflow-y-auto")]);
								
								props.child("1", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Flex, Style::Noop("min-h-full"), Style::Noop("items-stretch"), Style::JustifyCenter, Style::Noop("text-center"), Style::OnScreen(Screen::Medium, &[Style::ItemsCenter]), Style::OnScreen(Screen::Medium, &[Style::PaddingX(Size::Exact(8))]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(16))])]);
									...
									props.child("1", Dynamic).run("div", |mut props| {
										...
										props.child("1", Dynamic).run("div", |mut props| {
											...
											props.child("3", Dynamic).run("div", |mut props| {
												props.styles(vec![Style::Noop("grid"), Style::Width(Size::Full), Style::Noop("grid-cols-1"), Style::Noop("items-start"), Style::Noop("gap-x-6"), Style::Noop("gap-y-8"), Style::OnScreen(Screen::Small, &[Style::Noop("grid-cols-12")]), Style::OnScreen(Screen::Large, &[Style::Noop("gap-x-8")])]);
												
												props.child("1", Dynamic).run("div", |mut props| {
													props.styles(vec![Style::Noop("aspect-h-3"), Style::Noop("aspect-w-2"), Style::Noop("overflow-hidden"), Style::Noop("rounded-lg"), Style::Color(Color::Fg(11)), Style::OnScreen(Screen::Small, &[Style::Noop("col-span-4")]), Style::OnScreen(Screen::Large, &[Style::Noop("col-span-5")])]);
												...
												props.child("3", Dynamic).run("div", |mut props| {
													props.styles(vec![Style::OnScreen(Screen::Small, &[Style::Noop("col-span-8")]), Style::OnScreen(Screen::Large, &[Style::Noop("col-span-7")])]);
													
													props.child("1", Dynamic).run("h2", |mut props| {
														props.styles(vec![Style::Noop("text-2xl"), Style::FontBold, Style::TextColor(Color::Fg(100)), Style::OnScreen(Screen::Small, &[Style::PaddingRight(Size::Exact(48))])]);
													...
													props.child("3", Dynamic).run("section", |mut props| {
														...
														props.child("3", Dynamic).run("p", |mut props| {
															props.styles(vec![Style::Noop("text-2xl"), Style::TextColor(Color::Fg(100))]);
														...
														props.child("3", Dynamic).run("form", |mut props| {
															...
															props.child("7", Dynamic).run("div", |mut props| {
																...
																props.child("3", Dynamic).run("fieldset", |mut props| {
																	...
																	props.child("3", Dynamic).run("div", |mut props| {
																		props.styles(vec![Style::Noop("grid"), Style::Noop("grid-cols-4"), Style::Noop("gap-4")]);
