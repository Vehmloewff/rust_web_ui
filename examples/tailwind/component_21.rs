...
impl Widget<'_> for Example21 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example21Props) {
		...
		ctx.child("1", Dynamic).run("div", |mut props| {
			...
			props.child("1", Dynamic).run("div", |mut props| {
				...
				props.child("3", Dynamic).run("div", |mut props| {
					...
					props.child("3", Dynamic).run("div", |mut props| {
						...
						props.child("1", Dynamic).run("div", |mut props| {
							...
							props.styles(vec![Style::Noop("relative"), Style::Noop("ml-auto"), Style::Flex, Style::Width(Size::Full), Style::Width(Size::Full), Style::Noop("max-w-xs"), Style::Noop("flex-col"), Style::Noop("overflow-y-auto"), Style::Noop("bg-white"), Style::PaddingY(Size::Exact(16)), Style::PaddingBottom(Size::Exact(48)), Style::Noop("shadow-xl")]);
							props.set_attribute("@click.away", "open = false");
							
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Flex, Style::ItemsCenter, Style::JustifyBetween, Style::PaddingX(Size::Exact(16))]);
								
								props.child("1", Dynamic).run("h2", |mut props| {
									props.styles(vec![Style::Noop("text-lg"), Style::Noop("font-medium"), Style::TextColor(Color::Fg(100))]);
								...
								props.child("3", Dynamic).run("button", |mut props| {
									...
									props.styles(vec![Style::Noop("-mr-2"), Style::Flex, Style::Width(Size::Exact(40)), Style::Width(Size::Exact(40)), Style::ItemsCenter, Style::JustifyCenter, Style::Noop("rounded-md"), Style::Noop("bg-white"), Style::Padding(Size::Exact(8)), Style::TextColor(Color::Fg(44))]);
							...
							props.child("5", Dynamic).run("form", |mut props| {
								props.styles(vec![Style::MarginTop(Size::Exact(16)), Style::Noop("border-t"), Style::Noop("border-gray-200")]);
								...
								props.child("3", Dynamic).run("ul", |mut props| {
									...
									props.styles(vec![Style::PaddingX(Size::Exact(8)), Style::PaddingY(Size::Exact(12)), Style::Noop("font-medium"), Style::TextColor(Color::Fg(100))]);
									
									props.child("1", Dynamic).run("li", |mut props| {
										props.child("1", Dynamic).run("a", |mut props| {
											props.set_attribute("href", "#");
											props.styles(vec![Style::Block, Style::PaddingX(Size::Exact(8)), Style::PaddingY(Size::Exact(12))]);
								...
								props.child("5", Dynamic).run("div", |mut props| {
									...
									props.child("1", Dynamic).run("h3", |mut props| {
										props.styles(vec![Style::Noop("-mx-2"), Style::Noop("-my-3"), Style::Noop("flow-root")]);
										
										props.child("1", Dynamic).run("button", |mut props| {
											props.set_attribute("type", "button");
											props.set_attribute("x-description", "Expand/collapse section button");
											props.styles(vec![Style::Flex, Style::Width(Size::Full), Style::ItemsCenter, Style::JustifyBetween, Style::Noop("bg-white"), Style::PaddingX(Size::Exact(8)), Style::PaddingY(Size::Exact(12)), Style::TextColor(Color::Fg(44)), Style::OnHover(&[Style::TextColor(Color::Fg(56))])]);
											...
											props.child("3", Dynamic).run("span", |mut props| {
												props.styles(vec![Style::MarginLeft(Size::Exact(24)), Style::Flex, Style::ItemsCenter]);
												
												props.child("1", Icon).run(|props| {
													props.style(vec![Style::Width(Size::Exact(20)), Style::Width(Size::Exact(20))]);
												});
												props.child("3", Icon).run(|props| {
													props.style(vec![Style::Width(Size::Exact(20)), Style::Width(Size::Exact(20))]);
												});
										...
										props.child("1", Dynamic).run("div", |mut props| {
											...
											props.child("1", Dynamic).run("div", |mut props| {
												...
												props.child("1", Dynamic).run("input", |mut props| {
													...
													props.styles(vec![Style::Width(Size::Exact(16)), Style::Width(Size::Exact(16)), Style::RoundedSmall, Style::Noop("border-gray-300"), Style::Noop("text-indigo-600"), Style::OnFocus(&[Style::Noop("ring-indigo-500")])]);
												});
												props.child("3", Dynamic).run("label", |mut props| {
													props.set_attribute("for", "filter-mobile-color-0");
													props.styles(vec![Style::MarginLeft(Size::Exact(12)), Style::Noop("min-w-0"), Style::Noop("flex-1"), Style::TextColor(Color::Fg(56))]);
				...
				props.child("5", Dynamic).run("main", |mut props| {
					...
					props.child("1", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Flex, Style::Noop("items-baseline"), Style::JustifyBetween, Style::Noop("border-b"), Style::Noop("border-gray-200"), Style::PaddingBottom(Size::Exact(24)), Style::PaddingTop(Size::Exact(96))]);
						
						props.child("1", Dynamic).run("h1", |mut props| {
							props.styles(vec![Style::Noop("text-4xl"), Style::FontBold, Style::Noop("tracking-tight"), Style::TextColor(Color::Fg(100))]);
						...
						props.child("3", Dynamic).run("div", |mut props| {
							...
							props.child("1", Dynamic).run("div", |mut props| {
								...
								props.child("1", Dynamic).run("div", |mut props| {
									props.child("1", Dynamic).run("button", |mut props| {
										props.set_attribute("type", "button");
										props.styles(vec![Style::Noop("group"), Style::InlineFlex, Style::JustifyCenter, Style::Noop("text-sm"), Style::Noop("font-medium"), Style::TextColor(Color::Fg(78)), Style::OnHover(&[Style::TextColor(Color::Fg(100))])]);
										...
										props.child("1", Icon).run(|props| {
											props.style(vec![Style::Noop("-mr-1"), Style::MarginLeft(Size::Exact(4)), Style::Width(Size::Exact(20)), Style::Width(Size::Exact(20)), Style::Noop("flex-shrink-0"), Style::TextColor(Color::Fg(44)), Style::NoopGroup("group-hover", &[Style::TextColor(Color::Fg(56))])]);
										});
									});
								});
								props.child("3", Dynamic).run("div", |mut props| {
									...
									props.child("1", Dynamic).run("div", |mut props| {
										...
										props.child("1", Dynamic).run("a", |mut props| {
											props.set_attribute("href", "#");
											props.styles(vec![Style::Noop("font-medium"), Style::TextColor(Color::Fg(100)), Style::Block, Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(8)), Style::Noop("text-sm")]);
										...
										props.child("3", Dynamic).run("a", |mut props| {
											props.set_attribute("href", "#");
											props.styles(vec![Style::TextColor(Color::Fg(56)), Style::Block, Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(8)), Style::Noop("text-sm")]);
							...
							props.child("3", Dynamic).run("button", |mut props| {
								props.set_attribute("type", "button");
								props.styles(vec![Style::Noop("-m-2"), Style::MarginLeft(Size::Exact(20)), Style::Padding(Size::Exact(8)), Style::TextColor(Color::Fg(44)), Style::OnHover(&[Style::TextColor(Color::Fg(56))]), Style::OnScreen(Screen::Small, &[Style::MarginLeft(Size::Exact(28))])]);
							...
							props.child("5", Dynamic).run("button", |mut props| {
								props.set_attribute("type", "button");
								props.styles(vec![Style::Noop("-m-2"), Style::MarginLeft(Size::Exact(16)), Style::Padding(Size::Exact(8)), Style::TextColor(Color::Fg(44)), Style::OnHover(&[Style::TextColor(Color::Fg(56))]), Style::OnScreen(Screen::Small, &[Style::MarginLeft(Size::Exact(24))]), Style::OnScreen(Screen::Large, &[Style::Noop("hidden")])]);
					...
					props.child("3", Dynamic).run("section", |mut props| {
						...
						props.styles(vec![Style::PaddingBottom(Size::Exact(96)), Style::PaddingTop(Size::Exact(24))]);
						...
						props.child("3", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("grid"), Style::Noop("grid-cols-1"), Style::Noop("gap-x-8"), Style::Noop("gap-y-10"), Style::OnScreen(Screen::Large, &[Style::Noop("grid-cols-4")])]);
							
							//  Filters 
							props.child("3", Dynamic).run("form", |mut props| {
								props.styles(vec![Style::Noop("hidden"), Style::OnScreen(Screen::Large, &[Style::Block])]);
								...
								props.child("3", Dynamic).run("ul", |mut props| {
									props.set_attribute("role", "list");
									props.styles(vec![Style::SpaceY(Size::Exact(16)), Style::Noop("border-b"), Style::Noop("border-gray-200"), Style::PaddingBottom(Size::Exact(24)), Style::Noop("text-sm"), Style::Noop("font-medium"), Style::TextColor(Color::Fg(100))]);
								...
								props.child("5", Dynamic).run("div", |mut props| {
									props.set_attribute("x-data", "{ open: false }");
									props.styles(vec![Style::Noop("border-b"), Style::Noop("border-gray-200"), Style::PaddingY(Size::Exact(24))]);
									
									props.child("1", Dynamic).run("h3", |mut props| {
										props.styles(vec![Style::Noop("-my-3"), Style::Noop("flow-root")]);
										
										props.child("1", Dynamic).run("button", |mut props| {
											props.set_attribute("type", "button");
											props.set_attribute("x-description", "Expand/collapse section button");
											props.styles(vec![Style::Flex, Style::Width(Size::Full), Style::ItemsCenter, Style::JustifyBetween, Style::Noop("bg-white"), Style::PaddingY(Size::Exact(12)), Style::Noop("text-sm"), Style::TextColor(Color::Fg(44)), Style::OnHover(&[Style::TextColor(Color::Fg(56))])]);
									...
									props.child("3", Dynamic).run("div", |mut props| {
										...
										props.child("1", Dynamic).run("div", |mut props| {
											props.styles(vec![Style::SpaceY(Size::Exact(16))]);
											...
											props.child("1", Dynamic).run("div", |mut props| {
												...
												props.child("3", Dynamic).run("label", |mut props| {
													...
													props.styles(vec![Style::MarginLeft(Size::Exact(12)), Style::Noop("text-sm"), Style::TextColor(Color::Fg(67))]);
							...
							//  Product grid 
							props.child("7", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::OnScreen(Screen::Large, &[Style::Noop("col-span-3")])]);
								
								props.child("1", Dynamic).run("x-placeholder", |mut props| {
									props.child("1", Dynamic).run("div", |mut props| {
										props.styles(vec![Style::Noop("relative"), Style::Width(Size::Exact(384)), Style::Noop("overflow-hidden"), Style::Noop("rounded-xl"), Style::Noop("border"), Style::Noop("border-dashed"), Style::Noop("border-gray-400"), Style::Noop("opacity-75"), Style::OnScreen(Screen::Large, &[Style::Width(Size::Full)])]);
										
										props.child("1", Icon).run(|props| {
											props.style(vec![Style::Noop("absolute"), Style::Noop("inset-0"), Style::Width(Size::Full), Style::Width(Size::Full), Style::Noop("stroke-gray-900/10")]);
										});
									});
								});
							});
