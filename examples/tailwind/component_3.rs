...
impl Widget<'_> for Example3 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example3Props) {
		...
		ctx.child("1", Dynamic).run("div", |mut props| {
			...
			props.child("1", Dynamic).run("nav", |mut props| {
				...
				props.child("1", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::Noop("mx-auto"), Style::Noop("max-w-7xl"), Style::PaddingX(Size::Exact(8)), Style::OnScreen(Screen::Small, &[Style::PaddingX(Size::Exact(24))]), Style::OnScreen(Screen::Large, &[Style::PaddingX(Size::Exact(32))])]);
					
					props.child("1", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::Noop("relative"), Style::Flex, Style::Width(Size::Exact(64)), Style::ItemsCenter, Style::JustifyBetween]);
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("absolute"), Style::Noop("inset-y-0"), Style::Noop("left-0"), Style::Flex, Style::ItemsCenter, Style::OnScreen(Screen::Small, &[Style::Noop("hidden")])]);
							
							//  Mobile menu button
							props.child("3", Dynamic).run("button", |mut props| {
								props.set_attribute("type", "button");
								props.styles(vec![Style::Noop("relative"), Style::InlineFlex, Style::ItemsCenter, Style::JustifyCenter, Style::Noop("rounded-md"), Style::Padding(Size::Exact(8)), Style::TextColor(Color::Fg(44)), Style::OnHover(&[Style::Color(Color::Fg(78))]), Style::OnHover(&[Style::Noop("text-white")]), Style::OnFocus(&[Style::Noop("outline-none")]), Style::OnFocus(&[Style::Noop("ring-2")]), Style::OnFocus(&[Style::Noop("ring-inset")]), Style::OnFocus(&[Style::Noop("ring-white")])]);
						...
						props.child("3", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Flex, Style::Noop("flex-1"), Style::ItemsCenter, Style::JustifyCenter, Style::OnScreen(Screen::Small, &[Style::Noop("items-stretch")]), Style::OnScreen(Screen::Small, &[Style::Noop("justify-start")])]);
							
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Flex, Style::Noop("flex-shrink-0"), Style::ItemsCenter]);
							...
							props.child("3", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Noop("hidden"), Style::OnScreen(Screen::Small, &[Style::MarginLeft(Size::Exact(24))]), Style::OnScreen(Screen::Small, &[Style::Block])]);
								
								props.child("1", Dynamic).run("div", |mut props| {
									props.styles(vec![Style::Flex, Style::SpaceX(Size::Exact(16))]);
						...
						props.child("5", Dynamic).run("div", |mut props| {
							...
							props.child("5", Dynamic).run("div", |mut props| {
								...
								props.child("1", Dynamic).run("div", |mut props| {
									props.child("1", Dynamic).run("button", |mut props| {
										props.set_attribute("type", "button");
										props.styles(vec![Style::Noop("relative"), Style::Flex, Style::Noop("rounded-full"), Style::Color(Color::Fg(89)), Style::Noop("text-sm"), Style::OnFocus(&[Style::Noop("outline-none")]), Style::OnFocus(&[Style::Noop("ring-2")]), Style::OnFocus(&[Style::Noop("ring-white")]), Style::OnFocus(&[Style::Noop("ring-offset-2")]), Style::OnFocus(&[Style::Noop("ring-offset-gray-800")])]);
				...
				props.child("3", Dynamic).run("div", |mut props| {
					...
					props.styles(vec![Style::OnScreen(Screen::Small, &[Style::Noop("hidden")])]);
					props.set_attribute("id", "mobile-menu");
					props.set_attribute("x-show", "open");
					
					props.child("1", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::SpaceY(Size::Exact(4)), Style::PaddingX(Size::Exact(8)), Style::PaddingBottom(Size::Exact(12)), Style::PaddingTop(Size::Exact(8))]);
