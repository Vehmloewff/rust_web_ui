...
impl Widget<'_> for Example17 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example17Props) {
		...
		ctx.child("1", Dynamic).run("div", |mut props| {
			...
			props.child("1", Dynamic).run("div", |mut props| {
				...
				props.child("1", Dynamic).run("div", |mut props| {
					props.styles(vec![Style::Noop("mx-auto"), Style::Noop("max-w-2xl"), Style::PaddingY(Size::Exact(64)), Style::OnScreen(Screen::Small, &[Style::PaddingY(Size::Exact(96))]), Style::OnScreen(Screen::Large, &[Style::Noop("max-w-none")]), Style::OnScreen(Screen::Large, &[Style::PaddingY(Size::Exact(128))])]);
					
					props.child("1", Dynamic).run("h2", |mut props| {
						props.styles(vec![Style::Noop("text-2xl"), Style::FontBold, Style::TextColor(Color::Fg(100))]);
						
						props.child("0", Label).run(|props| props.text("Collections"));
					});
					props.child("3", Dynamic).run("div", |mut props| {
						props.styles(vec![Style::MarginTop(Size::Exact(24)), Style::SpaceY(Size::Exact(48)), Style::OnScreen(Screen::Large, &[Style::Noop("grid")]), Style::OnScreen(Screen::Large, &[Style::Noop("grid-cols-3")]), Style::OnScreen(Screen::Large, &[Style::Noop("gap-x-6")]), Style::OnScreen(Screen::Large, &[Style::SpaceY(Size::Exact(0))])]);
						
						props.child("1", Dynamic).run("div", |mut props| {
							props.styles(vec![Style::Noop("group"), Style::Noop("relative")]);
							
							props.child("1", Dynamic).run("div", |mut props| {
								props.styles(vec![Style::Noop("relative"), Style::Width(Size::Exact(320)), Style::Width(Size::Full), Style::Noop("overflow-hidden"), Style::Noop("rounded-lg"), Style::Noop("bg-white"), Style::OnScreen(Screen::Small, &[Style::Noop("aspect-h-1")]), Style::OnScreen(Screen::Small, &[Style::Noop("aspect-w-2")]), Style::OnScreen(Screen::Large, &[Style::Noop("aspect-h-1")]), Style::OnScreen(Screen::Large, &[Style::Noop("aspect-w-1")]), Style::NoopGroup("group-hover", &[Style::Noop("opacity-75")]), Style::OnScreen(Screen::Small, &[Style::Width(Size::Exact(256))])]);
							...
							props.child("3", Dynamic).run("h3", |mut props| {
								props.styles(vec![Style::MarginTop(Size::Exact(24)), Style::Noop("text-sm"), Style::TextColor(Color::Fg(56))]);
							...
							props.child("5", Dynamic).run("p", |mut props| {
								props.styles(vec![Style::Noop("text-base"), Style::FontSemibold, Style::TextColor(Color::Fg(100))]);
