...
impl Widget<'_> for Example7 {
	...
	fn render(mut ctx: Ctx<'_>, _props: Example7Props) {
						...
						props.child("1", Dynamic).run("div", |mut props| {
							...
							props.child("7", Dynamic).run("form", |mut props| {
								...
								props.child("1", Dynamic).run("button", |mut props| {
									...
									props.styles(vec![Style::TextColor(Color::Fg(78)), Style::Block, Style::Width(Size::Full), Style::PaddingX(Size::Exact(16)), Style::PaddingY(Size::Exact(8)), Style::Noop("text-left"), Style::Noop("text-sm")]);
